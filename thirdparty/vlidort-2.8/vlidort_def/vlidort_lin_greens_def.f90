...
! ###################################################################
      ...
      MODULE VLIDORT_LinGreens_def_m


!  1/31/21. Version 2.8.3.
!    -- This module contains the Green's function linearized solution arrays
!    -- First introduced in an experimentall version, 4/15/20. Rob Spurr.
!    -- Single average secant only

      USE VLIDORT_PARS_m, Only : MAXEVALUES, MAX_PARTLAYERS, MAXLAYERS, MAX_ATMOSWFS, &
...
!   Will only be calculated as output, if the flag has been set
      ...
      END TYPE VLIDORT_LinWork_Greens
...
!  EVERYTHING PUBLIC HERE
      ...
      PRIVATE
      PUBLIC :: VLIDORT_LinWork_Greens

   END MODULE VLIDORT_LinGreens_def_m
