...
!  1/31/21. Version 2.8.3, DOUBLET GEOMETRY option (flag do_doublet added)
...
!    -- 1/31/21. Version 2.8.3. Doublet flag added
...
!    -- 1/31/21. Version 2.8.3. Offset arrays added
...
!  1/31/21. Version 2.8.3. Additional Geometry array theta_all output, for MSST operations
...
!  Other angles
!    -- 1/31/21. Version 2.8.3. theta_all moved from here, now output
...
!  1/31/21. Version 2.8.3. Removed offsets (now inputs)
...
!  Mode bookkeeping
!    -- 1/31/21. Version 2.8.3. Doublet mode added
...
!      -- 1/31/21. Version 2.8.3. Section added for Doublet option
...
!  Offsets. 1/31/21. Version 2.8.3. Now an input
!      do ns = 1, nszas
...
!  1/31/21. Version 2.8.3. Add call to Doublet-geometry calculation
...
!  1/31/21. Version 2.8.3. Add calls to Doublet-geometry calculation
...
!     -- 1/31/21. Version 2.8.3. LOSCopy1_EnhancedPS_Doublet is new
!  rob & mick fix 6/30/2021 - removed extra call to "LOSCopy1_EnhancedPS_Lattice" before this IF block
...
!     -- 1/31/21. Version 2.8.3. Add Doublet Routine
