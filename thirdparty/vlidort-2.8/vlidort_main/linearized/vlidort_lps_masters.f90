...
!  Misc. help
      ...
      INTEGER ::          OFF, O1, UA, UM, IB, G, G1, G2, N, K, L, Q, Q1, UTA, LUM, LUA, NMOMS, NWFS
...
!  5/24/21. Version 2.8.3. Add DO_INCLUDE_SLEAVEWFS as an output
        ...
        CALL VLIDORT_LPS_FOURIER ( FOURIER, DO_FOURIER0_NSTOKES2, &
...
!    -- Follow the LIDORT pattern, dedicated subroutine only for profile output.
      ...
      IF (DO_FOCORR_EXTERNAL) THEN
        CALL VLIDORT_WRITE_LPS_SUP_SS_INPUT ( &
...
!    - (5/24/21). Add DO_INCLUDE_SLEAVEWFS
      ...
      SUBROUTINE VLIDORT_LPS_FOURIER ( FOURIER, DO_FOURIER0_NSTOKES2,  &
