        ...
        DO MOM=0,NMOMENTS_INPUT
          DO WF=1,N_WFS
            WRITE(OUTUNIT,DWFR3) &
              ...
              ' L_PHASMOMS_TOTAL_INPUT(WF,MOM,LAY) = ',&
                L_PHASMOMS_TOTAL_INPUT(WF,MOM,LAY)
          END DO
        END DO
      END DO
...
!  Open output file
      ...
      OUTUNIT = 113
      OPEN (OUTUNIT,file = 'LIDORT_WRITE_LPS_SUP_SS_INPUT.dbg',&
            status = 'replace')
...
!  Open output file
      ...
      OUTUNIT = 113
      OPEN (OUTUNIT,file = 'LIDORT_WRITE_LCS_SUP_SS_INPUT.dbg',&
            status = 'replace')
