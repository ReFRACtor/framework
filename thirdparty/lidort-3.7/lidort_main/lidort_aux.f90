...
!private
!public :: LIDORT_WRITE_STATUS

public

! ###############################################################
! #                                                             #
! #  This is LIDORT_AUX.f. This is a collection of utility      #
...
!    Thread removal for Version 3.7. 02 May 2014

      USE LIDORT_pars, only : MAX_MESSAGES,   LIDORT_SUCCESS, &
...
!  module, dimensions and numbers
      ...
      USE LIDORT_pars, only : MAXSTREAMS, MAXSTREAMS_2, ZERO, ONE
...
!  module, dimensions and numbers
      ...
      USE LIDORT_pars, only : MAX_MESSAGES, LIDORT_SERIOUS
...
!  subroutine Output or In/Out arguments
      ...
      CHARACTER*(*), intent(inout) :: MESSAGES(0:MAX_MESSAGES), ACTIONS(0:MAX_MESSAGES)
