...
!mick fix 2/14/2015 - modified if condition
      !IF ( DO_SOLAR_SOURCES ) THEN
...
!    write(*,*)'done emult'
!    do um = 1, nlayers
!       write(*,*)um,emult_up(1,um,1),deltau_vert(um)
!    enddo
...
!mick mod 2/14/2015 - consolidated if conditions
...
!  Thermal Cutoff argument added 5/15/15
          ...
          ( FOURIER_COMPONENT, TAYLOR_ORDER, DO_OBSERVATION_GEOMETRY,                                              & ! input
            ...
            NTOTAL, N_SUPDIAG, N_SUBDIAG, N_PARTLAYERS, N_THERMAL_COEFFS, TCUTOFF,                                 & ! input
...
!mick fix 2/14/2015 - added if condition and moved azimuth block from
...
!mick fix 2/14/2015 - added if condition
      IF ( DO_USER_STREAMS ) THEN
        CALL HMULT_MASTER                                                   &
...
!mick fix 2/14/2015 - modified if conditions for THERMAL_STERMS_UP & THERMAL_STERMS_DN
