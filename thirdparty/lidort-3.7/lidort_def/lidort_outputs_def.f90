...
!  Direct-beam quantities added 26 May 2011
      ...
      REAL(fpk), dimension ( MAX_USER_LEVELS, MAXBEAMS, MAX_DIRECTIONS ) :: TS_MEAN_INTENSITY
      REAL(fpk), dimension ( MAX_USER_LEVELS, MAXBEAMS, MAX_DIRECTIONS ) :: TS_FLUX_INTEGRAL

      REAL(fpk), dimension ( MAX_USER_LEVELS, MAXBEAMS ) :: TS_DNFLUX_DIRECT
      REAL(fpk), dimension ( MAX_USER_LEVELS, MAXBEAMS ) :: TS_DNMEAN_DIRECT
