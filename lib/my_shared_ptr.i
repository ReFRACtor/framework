// This is based on "boost_shared_ptr.i" from SWIG Github revision 6470fe,
// which has not as of this writing been released. Also some fixes from 
// earlier framework revisions have been kept in place.
///
// The updates from SWIG Github allow plain values to get passed properly
// through directors.
//
// The framework fixes are related to proper handling of shared_ptr returned by
// directors.
...
%typemap(directorin, fragment="SWIG_null_deleter_python") CONST TYPE * %{
  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *smartresult = $1 ? new SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >($1 SWIG_NO_NULL_DELETER_0) : 0;
  $input = SWIG_NewPointerObj(%as_voidptr(smartresult), $descriptor(SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< TYPE > *), SWIG_POINTER_OWN | %newpointer_flags);
%}
...
%typemap(directorin, fragment="SWIG_null_deleter_python") TYPE *CONST& %{
  SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE > *smartresult = $1 ? new SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< CONST TYPE >($1 SWIG_NO_NULL_DELETER_0) : 0;
  $input = SWIG_NewPointerObj(%as_voidptr(smartresult), $descriptor(SWIG_SHARED_PTR_QNAMESPACE::shared_ptr< TYPE > *), SWIG_POINTER_OWN | %newpointer_flags);
%}
