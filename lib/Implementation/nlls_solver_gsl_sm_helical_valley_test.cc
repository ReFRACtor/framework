...
BOOST_FIXTURE_TEST_SUITE(nlls_solver_gsl_sm_helical_valley, GlobalFixture)

/* convergence check thresholds */
//double x_tol=1.0e-6, g_tol=6.0555e-06, f_tol=1.0e-6;
double x_tol=1.0e-6, g_tol=1.0e-06, f_tol=1.0e-6;
bool verbose=false;


BOOST_AUTO_TEST_CASE(helical_valley_gsl_sm__default)
{
  //  Create the problem
  //
  ...
  // std::cout 
  //    << "Testing NLLSSolverGSLSM with Helical Valley function:" << std::endl
...
BOOST_AUTO_TEST_CASE(helical_valley_gsl_sm__lm_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(3); x0 = -1.0, 0.0, 0.0;
...
BOOST_AUTO_TEST_CASE(helical_valley_gsl_sm__lmaccel_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(3); x0 = -1.0, 0.0, 0.0;
...
BOOST_AUTO_TEST_CASE(helical_valley_gsl_sm__subspace2D_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(3); x0 = -1.0, 0.0, 0.0;
...
BOOST_AUTO_TEST_CASE(helical_valley_gsl_sm__ddogleg_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(3); x0 = -1.0, 0.0, 0.0;
