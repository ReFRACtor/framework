...
BOOST_FIXTURE_TEST_SUITE(nlls_solver_gsl_sm_freudenstein_roth_a, GlobalFixture)
...
BOOST_AUTO_TEST_CASE(freudenstein_roth_a_gsl_sm__default)
{
  //  Create the problem
  //
...
BOOST_AUTO_TEST_CASE(freudenstein_roth_a_gsl_sm__lm_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.5, -2.0;
...
BOOST_AUTO_TEST_CASE(freudenstein_roth_a_gsl_sm__lmaccel_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.5, -2.0;
...
BOOST_AUTO_TEST_CASE(freudenstein_roth_a_gsl_sm__subspace2D_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.5, -2.0;
...
BOOST_AUTO_TEST_CASE(freudenstein_roth_a_gsl_sm__ddogleg_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.5, -2.0;
