...
BOOST_FIXTURE_TEST_SUITE(nlls_solver_gsl_sm_brown, GlobalFixture)
...
BOOST_AUTO_TEST_CASE(brown_gsl_sm__default)
{
  //  Create the problem
  //
  ...
  // std::cout 
  //    << "Testing NLLSSolverGSLSM with Brown function:" << std::endl
...
BOOST_AUTO_TEST_CASE(brown_gsl_sm__lm_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 1.0, 1.0;
...
BOOST_AUTO_TEST_CASE(brown_gsl_sm__lmaccel_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 1.0, 1.0;
...
BOOST_AUTO_TEST_CASE(brown_gsl_sm__subspace2D_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 1.0, 1.0;
...
BOOST_AUTO_TEST_CASE(brown_gsl_sm__ddogleg_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 1.0, 1.0;
