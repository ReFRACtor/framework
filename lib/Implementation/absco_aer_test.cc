...
BOOST_AUTO_TEST_CASE(basic)
{
  ...
  AbscoAer f(absco_data_dir() + "/o2_v3.3.0-lowres.hdf");
  // Note scale here is a nonsense value
  double table_scale = 1.2;
  AbscoAer fscale(absco_data_dir() + "/o2_v3.3.0-lowres.hdf", table_scale);
...
BOOST_AUTO_TEST_CASE(scale_specindex)
{
  ...
  AbscoAer f(absco_data_dir() + "/co2_v3.3.0-lowres.hdf");
  AbscoAer fscale(absco_data_dir() + "/co2_v3.3.0-lowres.hdf", sb, tscale);
...
BOOST_AUTO_TEST_CASE(absco_4d)
{
  ...
  AbscoAer f(absco_4d_dir() + "/o2_v4.2.0_drouin.hdf");
