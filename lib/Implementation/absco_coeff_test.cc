...
BOOST_AUTO_TEST_CASE(basic)
{
  ...
  AbscoCoeff f(absco_data_dir() + "/legacy/o2_v151005_cia_mlawer_v151005r1_narrow.h5");
  // Note scale here is a nonsense value
  double table_scale = 1.2;
  AbscoCoeff fscale(absco_data_dir() + "/legacy/o2_v151005_cia_mlawer_v151005r1_narrow.h5", table_scale);
...
BOOST_AUTO_TEST_CASE(scale_specindex)
{
  ...
  AbscoCoeff f(absco_data_dir() + "/legacy/co2_devi2015_wco2scale-nist_sco2scale-unity.h5");
  AbscoCoeff fscale(absco_data_dir() + "/legacy/co2_devi2015_wco2scale-nist_sco2scale-unity.h5", sb, tscale);
...
BOOST_AUTO_TEST_CASE(serialization)
{
  ...
  boost::shared_ptr<AbscoCoeff> a =
    boost::make_shared<AbscoCoeff>(absco_data_dir() + "/legacy/o2_v151005_cia_mlawer_v151005r1_narrow.h5");
