...
BOOST_FIXTURE_TEST_SUITE(nlls_solver_gsl_sm_jennrich_sampson, GlobalFixture)
...
BOOST_AUTO_TEST_CASE(jennrich_sampson_gsl_sm__default)
{
  //  Create the problem
  //
  ...
  //
  NLLSSolverGSLSM solver(nlls, 100);
  ...
  // std::cout 
  //    << "Testing NLLSSolverGSLSM with Jennrich/Sampson function:" << std::endl
...
BOOST_AUTO_TEST_CASE(jennrich_sampson_gsl_sm__lm_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.3, 0.4;
  ...
  //
  NLLSSolverGSLSM solver(nlls, 100, fdf_params);
  BOOST_CHECK_EQUAL((int)solver.status(), (int)NLLSSolverGSLSM::UNTRIED);
  solver.solve();
...
BOOST_AUTO_TEST_CASE(jennrich_sampson_gsl_sm__lmaccel_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.3, 0.4;
...
BOOST_AUTO_TEST_CASE(jennrich_sampson_gsl_sm__subspace2D_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.3, 0.4;
...
BOOST_AUTO_TEST_CASE(jennrich_sampson_gsl_sm__ddogleg_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = 0.3, 0.4;
