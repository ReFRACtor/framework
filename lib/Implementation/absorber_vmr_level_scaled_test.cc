...
BOOST_FIXTURE_TEST_SUITE(absorber_vmr_level_scaled, MetDataFixture)
...
BOOST_AUTO_TEST_CASE(basic)
{
  ...
  AbsorberVmrLevelScaled avmr2(pressure_reverse,
	       grid_expect.reverse(blitz::firstDim), 1.0, "H2O");
