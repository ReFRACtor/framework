...
BOOST_FIXTURE_TEST_SUITE(nlls_solver_gsl_sm_rosenbrock2, GlobalFixture)
...
BOOST_AUTO_TEST_CASE(rosenbrock2_gsl_sm__default)
{
  //  Create the problem
  //
  ...
  // std::cout 
  //    << "Testing NLLSSolverGSLSM with Rosenbrock function:" << std::endl
...
BOOST_AUTO_TEST_CASE(rosenbrock2_gsl_sm__lm_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = -1.2, 1.0;
...
BOOST_AUTO_TEST_CASE(rosenbrock2_gsl_sm__lmaccel_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = -1.2, 1.0;
  ...
  //  is set to the accelerated Lev/Mar trust region method
  //  with More's scaling, and it will use SVD for solving 
  //  linear systems.
  //
  gsl_multifit_nlinear_parameters fdf_params=gsl_multifit_nlinear_default_parameters();
...
BOOST_AUTO_TEST_CASE(rosenbrock2_gsl_sm__subspace2D_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = -1.2, 1.0;
...
BOOST_AUTO_TEST_CASE(rosenbrock2_gsl_sm__ddogleg_more_svd)
{
  //  Create the problem
  //
  Array<double, 1> x0(2); x0 = -1.2, 1.0;
