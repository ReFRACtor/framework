...
void SolarAbsorptionSpectrum::serialize(Archive & ar,
			const unsigned int UNUSED(version))
{
  FP_GENERIC_BASE(SolarAbsorptionSpectrum);
...
FP_IMPLEMENT(SolarAbsorptionSpectrum);
#endif

#ifdef HAVE_LUA
#include "register_lua.h"
REGISTER_LUA_CLASS(SolarAbsorptionSpectrum)
REGISTER_LUA_END()
#endif
