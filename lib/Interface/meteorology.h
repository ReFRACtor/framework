...
public:
  ...
  //-----------------------------------------------------------------------
  virtual blitz::Array<double, 1> specific_humidity
  ...
  //-----------------------------------------------------------------------
  virtual blitz::Array<double, 1> vmr(const std::string& Species,
	      const blitz::Array<double, 1>& Pressure_level) const;
  ...
  //-----------------------------------------------------------------------
  /// Temperature profile in Kelvins interpolated to the requested
  /// pressure levels
  //-----------------------------------------------------------------------
  virtual blitz::Array<double, 1> temperature
  (const blitz::Array<double, 1>& Pressure_level) const;
...
protected:
  ...
  //-----------------------------------------------------------------------
  blitz::Array<double, 1> interpolate_to_grid
  (const blitz::Array<double, 1>& Profile,
   const blitz::Array<double, 1>& Dest_pressure_levels) const;
private:
