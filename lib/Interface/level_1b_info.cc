...
double Level1bInfo::obs_distance(std::shared_ptr<Level1b> level1b_ptr, double lat, double lon) {
...
bool Level1bInfo::compare_level1b_distance(std::shared_ptr<Level1b>& level1b_1, std::shared_ptr<Level1b>& level1b_2, double lat, double lon) {
...
bool Level1bInfo::compare_level1b_time(std::shared_ptr<Level1b>& level1b_1, std::shared_ptr<Level1b>& level1b_2, Time search_time) {
...
std::vector<std::shared_ptr<Level1b>> Level1bInfo::closest_obs_n(double lat, double lon, int n) {
    std::vector<std::shared_ptr<Level1b>> all_level1b = level1b_list();
    ...
    std::vector<std::shared_ptr<Level1b>> closest_observations = std::vector<std::shared_ptr<Level1b>>();
...
std::shared_ptr<Level1b> Level1bInfo::closest_obs(double lat, double lon) {
    std::vector<std::shared_ptr<Level1b>> closest = closest_obs_n(lat, lon, 1);
    // TODO: What do we return if no obs from above? all_observation.size() == 0
    return closest.front();    
}

std::vector<std::shared_ptr<Level1b>> Level1bInfo::closest_obs_n(Time search_time, int n) {
    std::vector<std::shared_ptr<Level1b>> all_level1b = level1b_list();
...
std::shared_ptr<Level1b> Level1bInfo::closest_obs(Time search_time) {
    std::vector<std::shared_ptr<Level1b>> closest = closest_obs_n(search_time, 1);
    // TODO: What do we return if no obs from above? all_observation.size() == 0
    return closest.front();    
}
