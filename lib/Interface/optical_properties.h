...
class OpticalProperties : public Printable<OpticalProperties> {
public:
...
//-----------------------------------------------------------------------
  ...
  virtual ArrayAd<double, 1> aerosol_extinction_optical_depth_per_layer()
    const = 0;
...
//-----------------------------------------------------------------------
  virtual ArrayAd<double, 1> aerosol_scattering_optical_depth_per_layer()
    const = 0;
...
//-----------------------------------------------------------------------
/// Fraction of the scattering attributable to each aerosol particle
/// at each layer
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
  ...
  rayleigh_phase_function_moments_portion(int num_scattering) const = 0;
...
//-----------------------------------------------------------------------
  ...
  virtual void print(std::ostream& Os) const {Os << "OpticalProperties";}
protected:
  OpticalProperties() {}
private:
...
FP_EXPORT_KEY(OpticalProperties);
#endif
