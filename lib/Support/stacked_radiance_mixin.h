...
class StackedRadianceMixin : public Printable<StackedRadianceMixin> {
public:
  virtual ~StackedRadianceMixin() {}
...
//-----------------------------------------------------------------------
/// The spectral grid of the radiance values, implemented by
/// inheriting class
//-----------------------------------------------------------------------
...
/// boost::optional class to return a value only if the range is not
/// empty.
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
  ...
  virtual void print(std::ostream& Os) const {Os << "StackedRadianceMixin";}
private:
...
FP_EXPORT_KEY(StackedRadianceMixin);
#endif
