...
void ArrayAd<double, 1>::serialize(Archive & ar, const unsigned int version)
{
...
template<> template<class Archive>
void ArrayAd<double, 2>::serialize(Archive & ar, const unsigned int version)
{
...
template<> template<class Archive>
void ArrayAd<double, 3>::serialize(Archive & ar, const unsigned int version)
{
...
template<> template<class Archive>
void ArrayAd<double, 4>::serialize(Archive & ar, const unsigned int version)
{
