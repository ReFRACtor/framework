...
BOOST_AUTO_TEST_CASE(closest_obs_n_distance)
{
    ...
    std::vector<boost::shared_ptr<Level1b>> closest_5 = example_level_1b_info.closest_obs_n(0.0, 0.0, 5);
...
BOOST_AUTO_TEST_CASE(closest_obs_distance)
{
    ...
    boost::shared_ptr<Level1b> closest = example_level_1b_info.closest_obs(0.0, 0.0);
...
BOOST_AUTO_TEST_CASE(closest_obs_n_time)
{
    ...
    std::vector<boost::shared_ptr<Level1b>> closest_5 = example_level_1b_info.closest_obs_n(Time::parse_time("2014-09-09T15:30:25.645049Z"), 5);
