...
void sup_init() {
  ...
  virtual void print(std::ostream &output_stream) const {
    output_stream << "Lidort_Inputs:" << std::endl
      ...
      << "lidort_inputstatus: " << lidort_inputstatus()  << std::endl;
...
void set_brdf_inputs() {
  ...
  virtual void print(std::ostream &output_stream) const {
    output_stream << "Lidort_Brdf_Sup_Accessories:" << std::endl
      ...
      << "           lidort_fixin: " << lidort_fixin()  << std::endl
      << "           lidort_modin: " << lidort_modin()  << std::endl
      << "lidort_brdfcheck_status: " << lidort_brdfcheck_status()  << std::endl
      << "           brdf_sup_out: " << brdf_sup_out()  << std::endl
      << "             lidort_sup: " << lidort_sup()  << std::endl;
...
// Serialization support
FP_EXPORT_KEY(Brdf_Lin_Sup_Masters)
FP_EXPORT_KEY(Brdf_Sup_Masters)
FP_EXPORT_KEY(Lidort_Inputs)
FP_EXPORT_KEY(Lidort_Masters)
FP_EXPORT_KEY(Lidort_L_Inputs)
FP_EXPORT_KEY(Lidort_Lcs_Masters)
FP_EXPORT_KEY(Lidort_Lps_Masters)
FP_EXPORT_KEY(Lidort_Brdf_Sup_Accessories)
