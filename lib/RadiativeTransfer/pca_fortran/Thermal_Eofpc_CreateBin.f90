module Thermal_Eofpc_CreateBin_m
...
subroutine create_bin_Thermal_V4 &
...
!      LIST_BINS = (/ 0.5,0.625,0.75,1.0,1.5,1.75,2.0,2.25,2.5,5.0,10.0 /) !11
!      LIST_BINS = (/ 0.01,0.025,0.05,0.1,0.25,0.5,0.625,0.75,1.0,5.0,10.0 /) !11 replaced tryout 4/3/19
      LIST_BINS = (/ 0.01,0.1,0.5,0.75,1.0,1.375,1.75,2.125,2.5,5.0,10.0 /) !11 4/10/19
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V4

subroutine create_bin_Thermal_V5 &
            ( E_nlayers, E_ndat, E_maxbins,           &
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V5

subroutine create_bin_Thermal_V6 &
            ( E_nlayers, E_ndat, E_maxbins,           &
              ndat, nlay, nbin, gasdat, taudp, omega, &
              ncnt,index,bin )
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V6

subroutine create_bin_Thermal_V3 &
            ( E_nlayers, E_ndat, E_maxbins,      &
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V3

subroutine create_bin_Thermal_V0 &
            ( E_nlayers, E_ndat, E_maxbins,      &
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V0

!

subroutine create_bin_Thermal_V2 &
            ( E_nlayers, E_ndat, E_maxbins,           &
              ndat, nlay, nbin, gasdat, taudp, omega, &
              ncnt,index,bin )
...
!   return
end subroutine create_bin_Thermal_V2

subroutine create_bin_Thermal_V1 &
            ( E_nlayers, E_ndat, E_maxbins,             &
...
!  finish
   ...
   return
end subroutine create_bin_Thermal_V1
...
end module Thermal_Eofpc_CreateBin_m
