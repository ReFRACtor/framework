module vlidort_interface_types
...
! Links to module: "vlidort_pars_m" in file: "vlidort_pars.f90.in"
type, bind(c) :: vlidort_pars_m_c
  character(kind=c_char) :: vlidort_version_number(3)
  integer(c_int) :: vlidort_inunit
  integer(c_int) :: vlidort_scenunit
  integer(c_int) :: vlidort_funit
  integer(c_int) :: vlidort_resunit
  integer(c_int) :: vlidort_errunit
  ...
  integer(c_int) :: max_szangles
  integer(c_int) :: max_user_vzangles
  ...
  integer(c_int) :: maxstokes_sq
  integer(c_int) :: maxsthalf_brdf
  integer(c_int) :: maxstreams_2
  integer(c_int) :: maxstreams_21
  integer(c_int) :: maxstreams_p1
  integer(c_int) :: maxstreams_p2
  integer(c_int) :: maxstrmstks
  integer(c_int) :: maxstrmstks_2
  integer(c_int) :: maxstrmstks_21
  integer(c_int) :: maxstrmstks_p1
  integer(c_int) :: maxstrmstks_p2
  integer(c_int) :: maxstrmstks_p4
  integer(c_int) :: max_ustrmstks
  integer(c_int) :: maxevalues
  integer(c_int) :: maxtotal
  integer(c_int) :: maxbandtotal
  integer(c_int) :: max_psols
  integer(c_int) :: max_scatpsols
  real(c_double) :: one
  real(c_double) :: zero
  real(c_double) :: onep5
  real(c_double) :: two
  ...
  integer(c_int) :: vlidort_serious
  integer(c_int) :: vlidort_warning
  integer(c_int) :: vlidort_info
  integer(c_int) :: vlidort_debug
  integer(c_int) :: vlidort_success
  integer(c_int) :: upidx
  integer(c_int) :: dnidx
...
end type vbrdf_linsup_inputs_c

! Links to type: "vbrdf_linsup_outputs" from module: "vbrdf_linsup_outputs_def_m" in file: "vbrdf_lin_sup_outputs_def.f90"
type, bind(c) :: vbrdf_linsup_outputs_c
  type(c_ptr) :: bs_ls_dbounce_brdfunc ! dimension(MAX_SURFACEWFS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(5) :: bs_ls_dbounce_brdfunc_f_shapes
  integer(c_int) :: bs_ls_dbounce_brdfunc_f_byte_size

  type(c_ptr) :: bs_ls_brdf_f_0 ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: bs_ls_brdf_f_0_f_shapes
  integer(c_int) :: bs_ls_brdf_f_0_f_byte_size

  type(c_ptr) :: bs_ls_brdf_f ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXSTREAMS)
  integer(c_int), dimension(5) :: bs_ls_brdf_f_f_shapes
  integer(c_int) :: bs_ls_brdf_f_f_byte_size

  type(c_ptr) :: bs_ls_user_brdf_f_0 ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: bs_ls_user_brdf_f_0_f_shapes
  integer(c_int) :: bs_ls_user_brdf_f_0_f_byte_size

  type(c_ptr) :: bs_ls_user_brdf_f ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS)
  integer(c_int), dimension(5) :: bs_ls_user_brdf_f_f_shapes
  integer(c_int) :: bs_ls_user_brdf_f_f_byte_size

  type(c_ptr) :: bs_ls_emissivity ! dimension(MAX_SURFACEWFS, MAXSTOKES, MAXSTREAMS)
  integer(c_int), dimension(3) :: bs_ls_emissivity_f_shapes
  integer(c_int) :: bs_ls_emissivity_f_byte_size

  type(c_ptr) :: bs_ls_user_emissivity ! dimension(MAX_SURFACEWFS, MAXSTOKES, MAX_USER_STREAMS)
  integer(c_int), dimension(3) :: bs_ls_user_emissivity_f_shapes
  integer(c_int) :: bs_ls_user_emissivity_f_byte_size

  
end type vbrdf_linsup_outputs_c

! Links to type: "vbrdf_sup_inputs" from module: "vbrdf_sup_inputs_def_m" in file: "vbrdf_sup_inputs_def.f90"
type, bind(c) :: vbrdf_sup_inputs_c
  ...
  type(c_ptr) :: bs_nstokes ! scalar
  integer(c_int) :: bs_nstokes_f_byte_size
  ...
  type(c_ptr) :: bs_do_newgcmglint ! scalar
  integer(c_int) :: bs_do_newgcmglint_f_byte_size
...
end type vbrdf_sup_inputs_c

! Links to type: "vbrdf_sup_outputs" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
type, bind(c) :: vbrdf_sup_outputs_c
  type(c_ptr) :: bs_dbounce_brdfunc ! dimension(MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(4) :: bs_dbounce_brdfunc_f_shapes
  integer(c_int) :: bs_dbounce_brdfunc_f_byte_size

  type(c_ptr) :: bs_brdf_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: bs_brdf_f_0_f_shapes
  integer(c_int) :: bs_brdf_f_0_f_byte_size

  type(c_ptr) :: bs_brdf_f ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXSTREAMS)
  integer(c_int), dimension(4) :: bs_brdf_f_f_shapes
  integer(c_int) :: bs_brdf_f_f_byte_size

  type(c_ptr) :: bs_user_brdf_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: bs_user_brdf_f_0_f_shapes
  integer(c_int) :: bs_user_brdf_f_0_f_byte_size

  type(c_ptr) :: bs_user_brdf_f ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS)
  integer(c_int), dimension(4) :: bs_user_brdf_f_f_shapes
  integer(c_int) :: bs_user_brdf_f_f_byte_size

  type(c_ptr) :: bs_emissivity ! dimension(MAXSTOKES, MAXSTREAMS)
  integer(c_int), dimension(2) :: bs_emissivity_f_shapes
  integer(c_int) :: bs_emissivity_f_byte_size

  type(c_ptr) :: bs_user_emissivity ! dimension(MAXSTOKES, MAX_USER_STREAMS)
...
type, bind(c) :: vsleave_sup_inputs_c
  ...
  integer(c_int) :: sl_vsleave_datapath_f_len
  ...
  type(c_ptr) :: sl_nstokes ! scalar
  integer(c_int) :: sl_nstokes_f_byte_size
...
type, bind(c) :: vlidort_fixed_lincontrol_c
  ...
  type(c_ptr) :: ts_n_totalprofile_wfs ! scalar
  integer(c_int) :: ts_n_totalprofile_wfs_f_byte_size
...
type, bind(c) :: vlidort_fixed_linoptical_c
  ...
  type(c_ptr) :: ts_l_greekmat_total_input ! dimension(MAX_ATMOSWFS, 0:MAXMOMENTS_INPUT, MAXLAYERS, MAXSTOKES_SQ)
  integer(c_int), dimension(4) :: ts_l_greekmat_total_input_f_shapes
  integer(c_int) :: ts_l_greekmat_total_input_f_byte_size

  type(c_ptr) :: ts_l_fmatrix_up ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_GEOMETRIES, 6)
  integer(c_int), dimension(4) :: ts_l_fmatrix_up_f_shapes
  integer(c_int) :: ts_l_fmatrix_up_f_byte_size

  type(c_ptr) :: ts_l_fmatrix_dn ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_GEOMETRIES, 6)
  integer(c_int), dimension(4) :: ts_l_fmatrix_dn_f_shapes
  integer(c_int) :: ts_l_fmatrix_dn_f_byte_size

  
end type vlidort_fixed_linoptical_c

! Links to type: "vlidort_fixed_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
type, bind(c) :: vlidort_fixed_lininputs_c
...
end type vlidort_modified_lincontrol_c

! Links to type: "vlidort_modified_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
type, bind(c) :: vlidort_modified_lininputs_c
  type(c_ptr) :: mcont ! scalar
  integer(c_int) :: mcont_f_byte_size

  
end type vlidort_modified_lininputs_c

! Links to type: "vlidort_lincol" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
type, bind(c) :: vlidort_lincol_c
  type(c_ptr) :: ts_columnwf ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_columnwf_f_shapes
  integer(c_int) :: ts_columnwf_f_byte_size

  type(c_ptr) :: ts_meanst_diffuse_colwf ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_meanst_diffuse_colwf_f_shapes
  integer(c_int) :: ts_meanst_diffuse_colwf_f_byte_size

  type(c_ptr) :: ts_flux_diffuse_colwf ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_flux_diffuse_colwf_f_shapes
  integer(c_int) :: ts_flux_diffuse_colwf_f_byte_size

  type(c_ptr) :: ts_dnmeanst_direct_colwf ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(4) :: ts_dnmeanst_direct_colwf_f_shapes
  integer(c_int) :: ts_dnmeanst_direct_colwf_f_byte_size

  type(c_ptr) :: ts_dnflux_direct_colwf ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(4) :: ts_dnflux_direct_colwf_f_shapes
  integer(c_int) :: ts_dnflux_direct_colwf_f_byte_size

  type(c_ptr) :: ts_albmed_user_colwf ! dimension(MAXSTOKES, MAX_USER_VZANGLES, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_albmed_user_colwf_f_shapes
  integer(c_int) :: ts_albmed_user_colwf_f_byte_size

  type(c_ptr) :: ts_trnmed_user_colwf ! dimension(MAXSTOKES, MAX_USER_VZANGLES, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_trnmed_user_colwf_f_shapes
  integer(c_int) :: ts_trnmed_user_colwf_f_byte_size

  type(c_ptr) :: ts_albmed_fluxes_colwf ! dimension(MAXSTOKES, 2, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_albmed_fluxes_colwf_f_shapes
  integer(c_int) :: ts_albmed_fluxes_colwf_f_byte_size

  type(c_ptr) :: ts_trnmed_fluxes_colwf ! dimension(MAXSTOKES, 2, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_trnmed_fluxes_colwf_f_shapes
  integer(c_int) :: ts_trnmed_fluxes_colwf_f_byte_size

  type(c_ptr) :: ts_transbeam_colwf ! dimension(MAXSTOKES, MAX_SZANGLES, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_transbeam_colwf_f_shapes
  integer(c_int) :: ts_transbeam_colwf_f_byte_size

  type(c_ptr) :: ts_planetary_transterm_colwf ! dimension(MAXSTOKES, MAX_GEOMETRIES, MAX_ATMOSWFS)
  integer(c_int), dimension(3) :: ts_planetary_transterm_colwf_f_shapes
  ...
  type(c_ptr) :: ts_lc_lostrans ! dimension(MAX_ATMOSWFS, MAX_SZANGLES, MAXLAYERS)
  integer(c_int), dimension(3) :: ts_lc_lostrans_f_shapes
  integer(c_int) :: ts_lc_lostrans_f_byte_size

  type(c_ptr) :: ts_lc_layer_mssts ! dimension(MAX_ATMOSWFS, MAX_SZANGLES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(4) :: ts_lc_layer_mssts_f_shapes
  integer(c_int) :: ts_lc_layer_mssts_f_byte_size

  type(c_ptr) :: ts_lc_surf_mssts ! dimension(MAX_ATMOSWFS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(3) :: ts_lc_surf_mssts_f_shapes
  integer(c_int) :: ts_lc_surf_mssts_f_byte_size

  
end type vlidort_lincol_c

! Links to type: "vlidort_linprof" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
type, bind(c) :: vlidort_linprof_c
  type(c_ptr) :: ts_profilewf ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(6) :: ts_profilewf_f_shapes
  integer(c_int) :: ts_profilewf_f_byte_size

  type(c_ptr) :: ts_meanst_diffuse_profwf ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(6) :: ts_meanst_diffuse_profwf_f_shapes
  integer(c_int) :: ts_meanst_diffuse_profwf_f_byte_size

  type(c_ptr) :: ts_flux_diffuse_profwf ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(6) :: ts_flux_diffuse_profwf_f_shapes
  integer(c_int) :: ts_flux_diffuse_profwf_f_byte_size

  type(c_ptr) :: ts_dnmeanst_direct_profwf ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(5) :: ts_dnmeanst_direct_profwf_f_shapes
  integer(c_int) :: ts_dnmeanst_direct_profwf_f_byte_size

  type(c_ptr) :: ts_dnflux_direct_profwf ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(5) :: ts_dnflux_direct_profwf_f_shapes
  integer(c_int) :: ts_dnflux_direct_profwf_f_byte_size

  type(c_ptr) :: ts_albmed_user_profwf ! dimension(MAXSTOKES, MAX_USER_VZANGLES, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_albmed_user_profwf_f_shapes
  integer(c_int) :: ts_albmed_user_profwf_f_byte_size

  type(c_ptr) :: ts_trnmed_user_profwf ! dimension(MAXSTOKES, MAX_USER_VZANGLES, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_trnmed_user_profwf_f_shapes
  integer(c_int) :: ts_trnmed_user_profwf_f_byte_size

  type(c_ptr) :: ts_albmed_fluxes_profwf ! dimension(MAXSTOKES, 2, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_albmed_fluxes_profwf_f_shapes
  integer(c_int) :: ts_albmed_fluxes_profwf_f_byte_size

  type(c_ptr) :: ts_trnmed_fluxes_profwf ! dimension(MAXSTOKES, 2, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_trnmed_fluxes_profwf_f_shapes
  integer(c_int) :: ts_trnmed_fluxes_profwf_f_byte_size

  type(c_ptr) :: ts_transbeam_profwf ! dimension(MAXSTOKES, MAX_SZANGLES, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_transbeam_profwf_f_shapes
  integer(c_int) :: ts_transbeam_profwf_f_byte_size

  type(c_ptr) :: ts_planetary_transterm_profwf ! dimension(MAXSTOKES, MAX_GEOMETRIES, MAXLAYERS, MAX_ATMOSWFS)
  integer(c_int), dimension(4) :: ts_planetary_transterm_profwf_f_shapes
  ...
  type(c_ptr) :: ts_lp_lostrans ! dimension(MAX_ATMOSWFS, MAX_SZANGLES, MAXLAYERS)
  integer(c_int), dimension(3) :: ts_lp_lostrans_f_shapes
  integer(c_int) :: ts_lp_lostrans_f_byte_size

  type(c_ptr) :: ts_lp_layer_mssts ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_SZANGLES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(5) :: ts_lp_layer_mssts_f_shapes
  integer(c_int) :: ts_lp_layer_mssts_f_byte_size

  type(c_ptr) :: ts_lp_surf_mssts ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(4) :: ts_lp_surf_mssts_f_shapes
  integer(c_int) :: ts_lp_surf_mssts_f_byte_size

  
end type vlidort_linprof_c

! Links to type: "vlidort_linatmos" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
type, bind(c) :: vlidort_linatmos_c
  type(c_ptr) :: ts_abbwfs_jacobians ! dimension(MAX_USER_LEVELS, MAX_USER_VZANGLES, 0:MAXLAYERS, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_abbwfs_jacobians_f_shapes
  integer(c_int) :: ts_abbwfs_jacobians_f_byte_size

  type(c_ptr) :: ts_abbwfs_fluxes ! dimension(MAX_USER_LEVELS, 2, 0:MAXLAYERS, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_abbwfs_fluxes_f_shapes
  integer(c_int) :: ts_abbwfs_fluxes_f_byte_size

  
end type vlidort_linatmos_c

! Links to type: "vlidort_linsurf" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
type, bind(c) :: vlidort_linsurf_c
  type(c_ptr) :: ts_surfacewf ! dimension(MAX_SURFACEWFS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_surfacewf_f_shapes
  integer(c_int) :: ts_surfacewf_f_byte_size

  type(c_ptr) :: ts_meanst_diffuse_surfwf ! dimension(MAX_SURFACEWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_meanst_diffuse_surfwf_f_shapes
  integer(c_int) :: ts_meanst_diffuse_surfwf_f_byte_size

  type(c_ptr) :: ts_flux_diffuse_surfwf ! dimension(MAX_SURFACEWFS, MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_flux_diffuse_surfwf_f_shapes
  integer(c_int) :: ts_flux_diffuse_surfwf_f_byte_size

  type(c_ptr) :: ts_ls_layer_mssts ! dimension(MAX_SURFACEWFS, MAX_SZANGLES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(4) :: ts_ls_layer_mssts_f_shapes
  integer(c_int) :: ts_ls_layer_mssts_f_byte_size

  type(c_ptr) :: ts_ls_surf_mssts ! dimension(MAX_SURFACEWFS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(3) :: ts_ls_surf_mssts_f_shapes
  integer(c_int) :: ts_ls_surf_mssts_f_byte_size

  type(c_ptr) :: ts_sbbwfs_jacobians ! dimension(MAX_USER_LEVELS, MAX_USER_VZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_sbbwfs_jacobians_f_shapes
  integer(c_int) :: ts_sbbwfs_jacobians_f_byte_size

  type(c_ptr) :: ts_sbbwfs_fluxes ! dimension(MAX_USER_LEVELS, 2, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_sbbwfs_fluxes_f_shapes
  integer(c_int) :: ts_sbbwfs_fluxes_f_byte_size

  
end type vlidort_linsurf_c

! Links to type: "vlidort_linoutputs" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
type, bind(c) :: vlidort_linoutputs_c
  type(c_ptr) :: col ! scalar
  integer(c_int) :: col_f_byte_size

  type(c_ptr) :: prof ! scalar
  integer(c_int) :: prof_f_byte_size
...
end type vlidort_linoutputs_c

! Links to type: "vlidort_linsup_brdf" from module: "vlidort_linsup_brdf_def_m" in file: "vlidort_lin_sup_brdf_def.f90"
type, bind(c) :: vlidort_linsup_brdf_c
  type(c_ptr) :: ts_ls_exactdb_brdfunc ! dimension(MAX_SURFACEWFS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_ls_exactdb_brdfunc_f_shapes
  integer(c_int) :: ts_ls_exactdb_brdfunc_f_byte_size

  type(c_ptr) :: ts_ls_brdf_f_0 ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_ls_brdf_f_0_f_shapes
  integer(c_int) :: ts_ls_brdf_f_0_f_byte_size

  type(c_ptr) :: ts_ls_brdf_f ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXSTREAMS)
  integer(c_int), dimension(5) :: ts_ls_brdf_f_f_shapes
  integer(c_int) :: ts_ls_brdf_f_f_byte_size

  type(c_ptr) :: ts_ls_user_brdf_f_0 ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_ls_user_brdf_f_0_f_shapes
  integer(c_int) :: ts_ls_user_brdf_f_0_f_byte_size

  type(c_ptr) :: ts_ls_user_brdf_f ! dimension(MAX_SURFACEWFS, 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS)
  integer(c_int), dimension(5) :: ts_ls_user_brdf_f_f_shapes
  integer(c_int) :: ts_ls_user_brdf_f_f_byte_size

  type(c_ptr) :: ts_ls_emissivity ! dimension(MAX_SURFACEWFS, MAXSTOKES, MAXSTREAMS)
  integer(c_int), dimension(3) :: ts_ls_emissivity_f_shapes
  integer(c_int) :: ts_ls_emissivity_f_byte_size

  type(c_ptr) :: ts_ls_user_emissivity ! dimension(MAX_SURFACEWFS, MAXSTOKES, MAX_USER_STREAMS)
  integer(c_int), dimension(3) :: ts_ls_user_emissivity_f_shapes
  integer(c_int) :: ts_ls_user_emissivity_f_byte_size

  
end type vlidort_linsup_brdf_c

! Links to type: "vlidort_linsup_sleave" from module: "vlidort_linsup_sleave_def_m" in file: "vlidort_lin_sup_sleave_def.f90"
type, bind(c) :: vlidort_linsup_sleave_c
  type(c_ptr) :: ts_lssl_slterm_isotropic ! dimension(MAX_SLEAVEWFS, MAXSTOKES, MAXBEAMS)
  integer(c_int), dimension(3) :: ts_lssl_slterm_isotropic_f_shapes
  integer(c_int) :: ts_lssl_slterm_isotropic_f_byte_size

  type(c_ptr) :: ts_lssl_slterm_userangles ! dimension(MAX_SLEAVEWFS, MAXSTOKES, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_lssl_slterm_userangles_f_shapes
  integer(c_int) :: ts_lssl_slterm_userangles_f_byte_size

  type(c_ptr) :: ts_lssl_slterm_f_0 ! dimension(MAX_SLEAVEWFS, 0:MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_lssl_slterm_f_0_f_shapes
  integer(c_int) :: ts_lssl_slterm_f_0_f_byte_size

  type(c_ptr) :: ts_lssl_user_slterm_f_0 ! dimension(MAX_SLEAVEWFS, 0:MAXMOMENTS, MAXSTOKES, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(5) :: ts_lssl_user_slterm_f_0_f_shapes
  integer(c_int) :: ts_lssl_user_slterm_f_0_f_byte_size

  
end type vlidort_linsup_sleave_c

! Links to type: "vlidort_linsup_ss_col" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
type, bind(c) :: vlidort_linsup_ss_col_c
  type(c_ptr) :: ts_columnwf_ss ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(5) :: ts_columnwf_ss_f_shapes
  integer(c_int) :: ts_columnwf_ss_f_byte_size

  type(c_ptr) :: ts_columnwf_db ! dimension(MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES)
  integer(c_int), dimension(4) :: ts_columnwf_db_f_shapes
  integer(c_int) :: ts_columnwf_db_f_byte_size

  
end type vlidort_linsup_ss_col_c

! Links to type: "vlidort_linsup_ss_prof" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
type, bind(c) :: vlidort_linsup_ss_prof_c
  type(c_ptr) :: ts_profilewf_ss ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(6) :: ts_profilewf_ss_f_shapes
  integer(c_int) :: ts_profilewf_ss_f_byte_size

  type(c_ptr) :: ts_profilewf_db ! dimension(MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES)
  integer(c_int), dimension(5) :: ts_profilewf_db_f_shapes
  integer(c_int) :: ts_profilewf_db_f_byte_size

  
end type vlidort_linsup_ss_prof_c

! Links to type: "vlidort_linsup_ss_surf" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
type, bind(c) :: vlidort_linsup_ss_surf_c
  type(c_ptr) :: ts_surfacewf_db ! dimension(MAX_SURFACEWFS, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES)
  integer(c_int), dimension(4) :: ts_surfacewf_db_f_shapes
  integer(c_int) :: ts_surfacewf_db_f_byte_size

  
end type vlidort_linsup_ss_surf_c

! Links to type: "vlidort_linsup_ss" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
type, bind(c) :: vlidort_linsup_ss_c
  type(c_ptr) :: col ! scalar
  integer(c_int) :: col_f_byte_size
...
end type vlidort_linsup_inout_c

! Links to type: "vlidort_main_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
type, bind(c) :: vlidort_main_outputs_c
  type(c_ptr) :: ts_stokes ! dimension(MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_stokes_f_shapes
  integer(c_int) :: ts_stokes_f_byte_size

  type(c_ptr) :: ts_meanst_diffuse ! dimension(MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_meanst_diffuse_f_shapes
  integer(c_int) :: ts_meanst_diffuse_f_byte_size

  type(c_ptr) :: ts_flux_diffuse ! dimension(MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_flux_diffuse_f_shapes
  integer(c_int) :: ts_flux_diffuse_f_byte_size

  type(c_ptr) :: ts_dnmeanst_direct ! dimension(MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(3) :: ts_dnmeanst_direct_f_shapes
  integer(c_int) :: ts_dnmeanst_direct_f_byte_size

  type(c_ptr) :: ts_dnflux_direct ! dimension(MAX_USER_LEVELS, MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(3) :: ts_dnflux_direct_f_shapes
  integer(c_int) :: ts_dnflux_direct_f_byte_size

  type(c_ptr) :: ts_albmed_user ! dimension(MAXSTOKES, MAX_USER_VZANGLES)
  integer(c_int), dimension(2) :: ts_albmed_user_f_shapes
  integer(c_int) :: ts_albmed_user_f_byte_size

  type(c_ptr) :: ts_trnmed_user ! dimension(MAXSTOKES, MAX_USER_VZANGLES)
  integer(c_int), dimension(2) :: ts_trnmed_user_f_shapes
  integer(c_int) :: ts_trnmed_user_f_byte_size

  type(c_ptr) :: ts_albmed_fluxes ! dimension(MAXSTOKES, 2)
  integer(c_int), dimension(2) :: ts_albmed_fluxes_f_shapes
  integer(c_int) :: ts_albmed_fluxes_f_byte_size

  type(c_ptr) :: ts_trnmed_fluxes ! dimension(MAXSTOKES, 2)
  integer(c_int), dimension(2) :: ts_trnmed_fluxes_f_shapes
  integer(c_int) :: ts_trnmed_fluxes_f_byte_size

  type(c_ptr) :: ts_planetary_transterm ! dimension(MAXSTOKES, MAX_GEOMETRIES)
  integer(c_int), dimension(2) :: ts_planetary_transterm_f_shapes
  ...
  type(c_ptr) :: ts_lostrans ! dimension(MAX_SZANGLES, MAXLAYERS)
  integer(c_int), dimension(2) :: ts_lostrans_f_shapes
  integer(c_int) :: ts_lostrans_f_byte_size

  type(c_ptr) :: ts_layer_mssts ! dimension(MAX_SZANGLES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(3) :: ts_layer_mssts_f_shapes
  integer(c_int) :: ts_layer_mssts_f_byte_size

  type(c_ptr) :: ts_surf_mssts ! dimension(MAX_SZANGLES, MAXSTOKES)
  integer(c_int), dimension(2) :: ts_surf_mssts_f_shapes
  integer(c_int) :: ts_surf_mssts_f_byte_size

  type(c_ptr) :: ts_contribs ! dimension(MAX_GEOMETRIES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(3) :: ts_contribs_f_shapes
  integer(c_int) :: ts_contribs_f_byte_size

  type(c_ptr) :: ts_fourier_saved ! dimension(MAX_SZANGLES)
  ...
  type(c_ptr) :: ts_sza_offsets ! dimension(MAX_SZANGLES)
  integer(c_int), dimension(1) :: ts_sza_offsets_f_shapes
  integer(c_int) :: ts_sza_offsets_f_byte_size

  type(c_ptr) :: ts_vza_offsets ! dimension(MAX_SZANGLES, MAX_USER_VZANGLES)
  integer(c_int), dimension(2) :: ts_vza_offsets_f_shapes
  integer(c_int) :: ts_vza_offsets_f_byte_size

  type(c_ptr) :: ts_szd_offsets ! dimension(MAX_SZANGLES)
  integer(c_int), dimension(1) :: ts_szd_offsets_f_shapes
  integer(c_int) :: ts_szd_offsets_f_byte_size
...
end type vlidort_main_outputs_c

! Links to type: "vlidort_wladjusted_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
type, bind(c) :: vlidort_wladjusted_outputs_c
  type(c_ptr) :: ts_wladjusted_isotropic ! dimension(MAXSTOKES, MAXBEAMS)
  integer(c_int), dimension(2) :: ts_wladjusted_isotropic_f_shapes
  integer(c_int) :: ts_wladjusted_isotropic_f_byte_size

  type(c_ptr) :: ts_wladjusted_direct ! dimension(MAXSTOKES, MAX_USER_VZANGLES, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_wladjusted_direct_f_shapes
  integer(c_int) :: ts_wladjusted_direct_f_byte_size

  type(c_ptr) :: ts_wladjusted_f_ords_0 ! dimension(0:MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_wladjusted_f_ords_0_f_shapes
  integer(c_int) :: ts_wladjusted_f_ords_0_f_byte_size

  type(c_ptr) :: ts_wladjusted_f_user_0 ! dimension(0:MAXMOMENTS, MAXSTOKES, MAX_USER_VZANGLES, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_wladjusted_f_user_0_f_shapes
  integer(c_int) :: ts_wladjusted_f_user_0_f_byte_size

  
end type vlidort_wladjusted_outputs_c

! Links to type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
type, bind(c) :: vlidort_exception_handling_c
...
end type vlidort_outputs_c

! Links to type: "vlidort_sup_brdf" from module: "vlidort_sup_brdf_def_m" in file: "vlidort_sup_brdf_def.f90"
type, bind(c) :: vlidort_sup_brdf_c
  type(c_ptr) :: ts_exactdb_brdfunc ! dimension(MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_exactdb_brdfunc_f_shapes
  integer(c_int) :: ts_exactdb_brdfunc_f_byte_size

  type(c_ptr) :: ts_brdf_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_brdf_f_0_f_shapes
  integer(c_int) :: ts_brdf_f_0_f_byte_size

  type(c_ptr) :: ts_brdf_f ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXSTREAMS)
  integer(c_int), dimension(4) :: ts_brdf_f_f_shapes
  integer(c_int) :: ts_brdf_f_f_byte_size

  type(c_ptr) :: ts_user_brdf_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_user_brdf_f_0_f_shapes
  integer(c_int) :: ts_user_brdf_f_0_f_byte_size

  type(c_ptr) :: ts_user_brdf_f ! dimension(0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS)
  integer(c_int), dimension(4) :: ts_user_brdf_f_f_shapes
  integer(c_int) :: ts_user_brdf_f_f_byte_size

  type(c_ptr) :: ts_emissivity ! dimension(MAXSTOKES, MAXSTREAMS)
  integer(c_int), dimension(2) :: ts_emissivity_f_shapes
  integer(c_int) :: ts_emissivity_f_byte_size

  type(c_ptr) :: ts_user_emissivity ! dimension(MAXSTOKES, MAX_USER_STREAMS)
  integer(c_int), dimension(2) :: ts_user_emissivity_f_shapes
  integer(c_int) :: ts_user_emissivity_f_byte_size

  
end type vlidort_sup_brdf_c

! Links to type: "vlidort_sup_sleave" from module: "vlidort_sup_sleave_def_m" in file: "vlidort_sup_sleave_def.f90"
type, bind(c) :: vlidort_sup_sleave_c
  type(c_ptr) :: ts_slterm_isotropic ! dimension(MAXSTOKES, MAXBEAMS)
  integer(c_int), dimension(2) :: ts_slterm_isotropic_f_shapes
  integer(c_int) :: ts_slterm_isotropic_f_byte_size

  type(c_ptr) :: ts_slterm_userangles ! dimension(MAXSTOKES, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_slterm_userangles_f_shapes
  integer(c_int) :: ts_slterm_userangles_f_byte_size

  type(c_ptr) :: ts_slterm_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_slterm_f_0_f_shapes
  integer(c_int) :: ts_slterm_f_0_f_byte_size

  type(c_ptr) :: ts_user_slterm_f_0 ! dimension(0:MAXMOMENTS, MAXSTOKES, MAX_USER_STREAMS, MAXBEAMS)
  integer(c_int), dimension(4) :: ts_user_slterm_f_0_f_shapes
  integer(c_int) :: ts_user_slterm_f_0_f_byte_size

  
end type vlidort_sup_sleave_c

! Links to type: "vlidort_sup_ss" from module: "vlidort_sup_ss_def_m" in file: "vlidort_sup_ss_def.f90"
type, bind(c) :: vlidort_sup_ss_c
  type(c_ptr) :: ts_stokes_ss ! dimension(MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS)
  integer(c_int), dimension(4) :: ts_stokes_ss_f_shapes
  integer(c_int) :: ts_stokes_ss_f_byte_size

  type(c_ptr) :: ts_stokes_db ! dimension(MAX_USER_LEVELS, MAX_GEOMETRIES, MAXSTOKES)
  integer(c_int), dimension(3) :: ts_stokes_db_f_shapes
  integer(c_int) :: ts_stokes_db_f_byte_size

  type(c_ptr) :: ts_contribs_ss ! dimension(MAX_GEOMETRIES, MAXSTOKES, MAXLAYERS)
  integer(c_int), dimension(3) :: ts_contribs_ss_f_shapes
  integer(c_int) :: ts_contribs_ss_f_byte_size

  
end type vlidort_sup_ss_c

! Links to type: "vlidort_sup_inout" from module: "vlidort_sup_inout_def_m" in file: "vlidort_sup_def.f90"
type, bind(c) :: vlidort_sup_inout_c
  type(c_ptr) :: brdf ! scalar
  integer(c_int) :: brdf_f_byte_size
...
type, bind(c) :: vlidort_fixed_boolean_c
  ...
  type(c_ptr) :: ts_do_lambertian_surface ! scalar
  integer(c_int) :: ts_do_lambertian_surface_f_byte_size

  type(c_ptr) :: ts_do_specialist_option_1 ! scalar
  integer(c_int) :: ts_do_specialist_option_1_f_byte_size

  type(c_ptr) :: ts_do_specialist_option_2 ! scalar
  integer(c_int) :: ts_do_specialist_option_2_f_byte_size

  type(c_ptr) :: ts_do_specialist_option_3 ! scalar
  integer(c_int) :: ts_do_specialist_option_3_f_byte_size
  ...
  type(c_ptr) :: ts_do_fourier0_nstokes2 ! scalar
  integer(c_int) :: ts_do_fourier0_nstokes2_f_byte_size

  
end type vlidort_fixed_boolean_c

! Links to type: "vlidort_fixed_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
type, bind(c) :: vlidort_fixed_control_c
  type(c_ptr) :: ts_taylor_order ! scalar
  integer(c_int) :: ts_taylor_order_f_byte_size

  type(c_ptr) :: ts_nstokes ! scalar
  integer(c_int) :: ts_nstokes_f_byte_size
  ...
  type(c_ptr) :: ts_vlidort_accuracy ! scalar
  integer(c_int) :: ts_vlidort_accuracy_f_byte_size

  type(c_ptr) :: ts_asymtx_tolerance ! scalar
  integer(c_int) :: ts_asymtx_tolerance_f_byte_size

  type(c_ptr) :: ts_nlayers_noms ! scalar
  integer(c_int) :: ts_nlayers_noms_f_byte_size

  type(c_ptr) :: ts_nlayers_cutoff ! scalar
  integer(c_int) :: ts_nlayers_cutoff_f_byte_size
...
type, bind(c) :: vlidort_fixed_optical_c
  ...
  type(c_ptr) :: ts_greekmat_total_input ! dimension(0:MAXMOMENTS_INPUT, MAXLAYERS, MAXSTOKES_SQ)
  integer(c_int), dimension(3) :: ts_greekmat_total_input_f_shapes
  integer(c_int) :: ts_greekmat_total_input_f_byte_size

  type(c_ptr) :: ts_fmatrix_up ! dimension(MAXLAYERS, MAX_GEOMETRIES, 6)
  integer(c_int), dimension(3) :: ts_fmatrix_up_f_shapes
  integer(c_int) :: ts_fmatrix_up_f_byte_size

  type(c_ptr) :: ts_fmatrix_dn ! dimension(MAXLAYERS, MAX_GEOMETRIES, 6)
  integer(c_int), dimension(3) :: ts_fmatrix_dn_f_shapes
  integer(c_int) :: ts_fmatrix_dn_f_byte_size
...
type, bind(c) :: vlidort_modified_boolean_c
  ...
  type(c_ptr) :: ts_do_sscorr_usefmat ! scalar
  integer(c_int) :: ts_do_sscorr_usefmat_f_byte_size
  ...
  type(c_ptr) :: ts_do_classical_solution ! scalar
  integer(c_int) :: ts_do_classical_solution_f_byte_size
  ...
  type(c_ptr) :: ts_do_user_vzangles ! scalar
  integer(c_int) :: ts_do_user_vzangles_f_byte_size
...
end type vlidort_modified_boolean_c

! Links to type: "vlidort_modified_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
type, bind(c) :: vlidort_modified_control_c
  type(c_ptr) :: ts_ngreek_moments_input ! scalar
  integer(c_int) :: ts_ngreek_moments_input_f_byte_size

  
end type vlidort_modified_control_c

! Links to type: "vlidort_modified_sunrays" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
type, bind(c) :: vlidort_modified_sunrays_c
  type(c_ptr) :: ts_n_szangles ! scalar
  integer(c_int) :: ts_n_szangles_f_byte_size

  type(c_ptr) :: ts_szangles ! dimension(MAX_SZANGLES)
  integer(c_int), dimension(1) :: ts_szangles_f_shapes
  integer(c_int) :: ts_szangles_f_byte_size

  
end type vlidort_modified_sunrays_c

! Links to type: "vlidort_modified_uservalues" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
type, bind(c) :: vlidort_modified_uservalues_c
  ...
  type(c_ptr) :: ts_n_user_vzangles ! scalar
  integer(c_int) :: ts_n_user_vzangles_f_byte_size

  type(c_ptr) :: ts_user_vzangles_input ! dimension(MAX_USER_VZANGLES)
  integer(c_int), dimension(1) :: ts_user_vzangles_input_f_shapes
  integer(c_int) :: ts_user_vzangles_input_f_byte_size
...
end type vlidort_modified_inputs_c


contains


subroutine set_vlidort_pars(pars_struct) bind(C)
  type(vlidort_pars_m_c) :: pars_struct
  integer :: len_idx

  do len_idx = 1, 3
    pars_struct%vlidort_version_number(len_idx:len_idx) = VLIDORT_VERSION_NUMBER(len_idx:len_idx)
  end do
  pars_struct%vlidort_inunit = VLIDORT_INUNIT
  pars_struct%vlidort_scenunit = VLIDORT_SCENUNIT
  pars_struct%vlidort_funit = VLIDORT_FUNIT
  pars_struct%vlidort_resunit = VLIDORT_RESUNIT
  pars_struct%vlidort_errunit = VLIDORT_ERRUNIT
  ...
  pars_struct%max_szangles = MAX_SZANGLES
  pars_struct%max_user_vzangles = MAX_USER_VZANGLES
  ...
  pars_struct%maxstokes = MAXSTOKES
  ...
  pars_struct%maxstokes_sq = MAXSTOKES_SQ
  pars_struct%maxsthalf_brdf = MAXSTHALF_BRDF
  pars_struct%maxstreams_2 = MAXSTREAMS_2
  pars_struct%maxstreams_21 = MAXSTREAMS_21
  pars_struct%maxstreams_p1 = MAXSTREAMS_P1
  pars_struct%maxstreams_p2 = MAXSTREAMS_P2
  pars_struct%maxstrmstks = MAXSTRMSTKS
  pars_struct%maxstrmstks_2 = MAXSTRMSTKS_2
  pars_struct%maxstrmstks_21 = MAXSTRMSTKS_21
  pars_struct%maxstrmstks_p1 = MAXSTRMSTKS_P1
  pars_struct%maxstrmstks_p2 = MAXSTRMSTKS_P2
  pars_struct%maxstrmstks_p4 = MAXSTRMSTKS_P4
  pars_struct%max_ustrmstks = MAX_USTRMSTKS
  pars_struct%maxevalues = MAXEVALUES
  pars_struct%maxtotal = MAXTOTAL
  pars_struct%maxbandtotal = MAXBANDTOTAL
  pars_struct%max_psols = MAX_PSOLS
  pars_struct%max_scatpsols = MAX_SCATPSOLS
  pars_struct%one = ONE
  ...
  pars_struct%taylor_large = TAYLOR_LARGE
  ...
  pars_struct%vlidort_serious = VLIDORT_SERIOUS
  pars_struct%vlidort_warning = VLIDORT_WARNING
  pars_struct%vlidort_info = VLIDORT_INFO
  pars_struct%vlidort_debug = VLIDORT_DEBUG
  pars_struct%vlidort_success = VLIDORT_SUCCESS
  ...
  pars_struct%gisscoxmunk_idx = GISSCOXMUNK_IDX
  pars_struct%gisscoxmunk_cri_idx = GISSCOXMUNK_CRI_IDX
  ...
  pars_struct%newgcmglint_idx = NEWGCMGLINT_IDX
...
end subroutine set_vlidort_pars



! Links to type: "vbrdf_linsup_inputs" from module: "vbrdf_linsup_inputs_def_m" in file: "vbrdf_lin_sup_inputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_linsup_inputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_linsup_inputs_def_m, only : vbrdf_linsup_inputs

  type(vbrdf_linsup_inputs_c), intent(inout) :: transfer_struct_c
  ...
  call vbrdf_linsup_inputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_linsup_inputs_c_alloc_init

! Links to type: "vbrdf_linsup_inputs" from module: "vbrdf_linsup_inputs_def_m" in file: "vbrdf_lin_sup_inputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_linsup_inputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
...
end subroutine vbrdf_linsup_inputs_c_init_only

subroutine vbrdf_linsup_inputs_c_destroy(fortran_type_c) bind(C)
  use vbrdf_linsup_inputs_def_m, only : vbrdf_linsup_inputs
...
end subroutine vbrdf_linsup_inputs_c_destroy

subroutine vbrdf_linsup_inputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_linsup_inputs_def_m, only : vbrdf_linsup_inputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_linsup_inputs), pointer :: fortran_type_f_from
  type(vbrdf_linsup_inputs), pointer :: fortran_type_f_to
...
end subroutine vbrdf_linsup_inputs_c_copy

! Links to type: "vbrdf_linsup_outputs" from module: "vbrdf_linsup_outputs_def_m" in file: "vbrdf_lin_sup_outputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_linsup_outputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_linsup_outputs_def_m, only : vbrdf_linsup_outputs

  type(vbrdf_linsup_outputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vbrdf_linsup_outputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_linsup_outputs_c_alloc_init

! Links to type: "vbrdf_linsup_outputs" from module: "vbrdf_linsup_outputs_def_m" in file: "vbrdf_lin_sup_outputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_linsup_outputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%bs_ls_dbounce_brdfunc = c_loc(bs_ls_dbounce_brdfunc_ptr(&
    ...
    lbound(fortran_type_f%bs_ls_dbounce_brdfunc,5)))
  ...
  transfer_struct_c%bs_ls_dbounce_brdfunc_f_shapes(5) = size(fortran_type_f%bs_ls_dbounce_brdfunc, 5)
  ...
  transfer_struct_c%bs_ls_brdf_f_0 = c_loc(bs_ls_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%bs_ls_brdf_f_0,5)))
  ...
  transfer_struct_c%bs_ls_brdf_f_0_f_shapes(5) = size(fortran_type_f%bs_ls_brdf_f_0, 5)
  ...
  transfer_struct_c%bs_ls_brdf_f = c_loc(bs_ls_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%bs_ls_brdf_f,5)))
  ...
  transfer_struct_c%bs_ls_brdf_f_f_shapes(5) = size(fortran_type_f%bs_ls_brdf_f, 5)
  ...
  transfer_struct_c%bs_ls_user_brdf_f_0 = c_loc(bs_ls_user_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%bs_ls_user_brdf_f_0,5)))
  ...
  transfer_struct_c%bs_ls_user_brdf_f_0_f_shapes(5) = size(fortran_type_f%bs_ls_user_brdf_f_0, 5)
  ...
  transfer_struct_c%bs_ls_user_brdf_f = c_loc(bs_ls_user_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%bs_ls_user_brdf_f,5)))
  ...
  transfer_struct_c%bs_ls_user_brdf_f_f_shapes(5) = size(fortran_type_f%bs_ls_user_brdf_f, 5)
...
end subroutine vbrdf_linsup_outputs_c_init_only

subroutine vbrdf_linsup_outputs_c_destroy(fortran_type_c) bind(C)
  use vbrdf_linsup_outputs_def_m, only : vbrdf_linsup_outputs
  ...
  deallocate(fortran_type_f)
end subroutine vbrdf_linsup_outputs_c_destroy

subroutine vbrdf_linsup_outputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_linsup_outputs_def_m, only : vbrdf_linsup_outputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_linsup_outputs), pointer :: fortran_type_f_from
  type(vbrdf_linsup_outputs), pointer :: fortran_type_f_to
...
end subroutine vbrdf_linsup_outputs_c_copy

! Links to type: "vbrdf_sup_inputs" from module: "vbrdf_sup_inputs_def_m" in file: "vbrdf_sup_inputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_sup_inputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_inputs_def_m, only : vbrdf_sup_inputs

  type(vbrdf_sup_inputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vbrdf_sup_inputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_sup_inputs_c_alloc_init

! Links to type: "vbrdf_sup_inputs" from module: "vbrdf_sup_inputs_def_m" in file: "vbrdf_sup_inputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_sup_inputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  integer(c_int), pointer :: bs_nstokes_ptr
  ...
  logical(kind=4), pointer :: bs_do_newgcmglint_ptr
  ...
  fortran_type_f%bs_nstokes = 0
  bs_nstokes_ptr => fortran_type_f%bs_nstokes
  transfer_struct_c%bs_nstokes = c_loc(bs_nstokes_ptr)
  inquire(iolength=transfer_struct_c%bs_nstokes_f_byte_size) fortran_type_f%bs_nstokes
#ifdef ifort
  transfer_struct_c%bs_nstokes_f_byte_size = transfer_struct_c%bs_nstokes_f_byte_size * 4
#endif
  ...
  fortran_type_f%bs_do_newgcmglint = .FALSE.
  bs_do_newgcmglint_ptr => fortran_type_f%bs_do_newgcmglint
  transfer_struct_c%bs_do_newgcmglint = c_loc(bs_do_newgcmglint_ptr)
  inquire(iolength=transfer_struct_c%bs_do_newgcmglint_f_byte_size) fortran_type_f%bs_do_newgcmglint
#ifdef ifort
  transfer_struct_c%bs_do_newgcmglint_f_byte_size = transfer_struct_c%bs_do_newgcmglint_f_byte_size * 4
#endif
...
end subroutine vbrdf_sup_inputs_c_init_only

subroutine vbrdf_sup_inputs_c_destroy(fortran_type_c) bind(C)
  use vbrdf_sup_inputs_def_m, only : vbrdf_sup_inputs
  ...
  deallocate(fortran_type_f)
end subroutine vbrdf_sup_inputs_c_destroy

subroutine vbrdf_sup_inputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_sup_inputs_def_m, only : vbrdf_sup_inputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_sup_inputs), pointer :: fortran_type_f_from
  type(vbrdf_sup_inputs), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%bs_nstokes = fortran_type_f_from%bs_nstokes
  ...
  fortran_type_f_to%bs_do_newgcmglint = fortran_type_f_from%bs_do_newgcmglint
...
end subroutine vbrdf_sup_inputs_c_copy

! Links to type: "vbrdf_sup_outputs" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_sup_outputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_sup_outputs

  type(vbrdf_sup_outputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vbrdf_sup_outputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_sup_outputs_c_alloc_init

! Links to type: "vbrdf_sup_outputs" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_sup_outputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%bs_dbounce_brdfunc = c_loc(bs_dbounce_brdfunc_ptr(&
    ...
    lbound(fortran_type_f%bs_dbounce_brdfunc,4)))
  ...
  transfer_struct_c%bs_dbounce_brdfunc_f_shapes(4) = size(fortran_type_f%bs_dbounce_brdfunc, 4)
  ...
  transfer_struct_c%bs_brdf_f_0 = c_loc(bs_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%bs_brdf_f_0,4)))
  ...
  transfer_struct_c%bs_brdf_f_0_f_shapes(4) = size(fortran_type_f%bs_brdf_f_0, 4)
  ...
  transfer_struct_c%bs_brdf_f = c_loc(bs_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%bs_brdf_f,4)))
  ...
  transfer_struct_c%bs_brdf_f_f_shapes(4) = size(fortran_type_f%bs_brdf_f, 4)
  ...
  transfer_struct_c%bs_user_brdf_f_0 = c_loc(bs_user_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%bs_user_brdf_f_0,4)))
  ...
  transfer_struct_c%bs_user_brdf_f_0_f_shapes(4) = size(fortran_type_f%bs_user_brdf_f_0, 4)
  ...
  transfer_struct_c%bs_user_brdf_f = c_loc(bs_user_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%bs_user_brdf_f,4)))
  ...
  transfer_struct_c%bs_user_brdf_f_f_shapes(4) = size(fortran_type_f%bs_user_brdf_f, 4)
...
end subroutine vbrdf_sup_outputs_c_init_only

subroutine vbrdf_sup_outputs_c_destroy(fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_sup_outputs
  ...
  deallocate(fortran_type_f)
end subroutine vbrdf_sup_outputs_c_destroy

subroutine vbrdf_sup_outputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_sup_outputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_sup_outputs), pointer :: fortran_type_f_from
  type(vbrdf_sup_outputs), pointer :: fortran_type_f_to
...
end subroutine vbrdf_sup_outputs_c_copy

! Links to type: "vbrdf_input_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_input_exception_handling_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_input_exception_handling

  type(vbrdf_input_exception_handling_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vbrdf_input_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_input_exception_handling_c_alloc_init

! Links to type: "vbrdf_input_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_input_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m
  use vlidort_pars_m
...
end subroutine vbrdf_input_exception_handling_c_init_only

subroutine vbrdf_input_exception_handling_c_destroy(fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_input_exception_handling
  ...
  deallocate(fortran_type_f)
end subroutine vbrdf_input_exception_handling_c_destroy

subroutine vbrdf_input_exception_handling_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_input_exception_handling

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_input_exception_handling), pointer :: fortran_type_f_from
  type(vbrdf_input_exception_handling), pointer :: fortran_type_f_to
...
end subroutine vbrdf_input_exception_handling_c_copy

! Links to type: "vbrdf_output_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Allocs and initializes type
subroutine vbrdf_output_exception_handling_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_output_exception_handling

  type(vbrdf_output_exception_handling_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vbrdf_output_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vbrdf_output_exception_handling_c_alloc_init

! Links to type: "vbrdf_output_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
! Initializes only with no allocation
subroutine vbrdf_output_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m
  use vlidort_pars_m
...
end subroutine vbrdf_output_exception_handling_c_init_only

subroutine vbrdf_output_exception_handling_c_destroy(fortran_type_c) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_output_exception_handling
  ...
  deallocate(fortran_type_f)
end subroutine vbrdf_output_exception_handling_c_destroy

subroutine vbrdf_output_exception_handling_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vbrdf_sup_outputs_def_m, only : vbrdf_output_exception_handling

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vbrdf_output_exception_handling), pointer :: fortran_type_f_from
  type(vbrdf_output_exception_handling), pointer :: fortran_type_f_to
...
end subroutine vbrdf_output_exception_handling_c_copy

! Links to type: "vsleave_sup_inputs" from module: "vsleave_sup_inputs_def_m" in file: "vsleave_sup_inputs_def.f90"
! Allocs and initializes type
subroutine vsleave_sup_inputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vsleave_sup_inputs_def_m, only : vsleave_sup_inputs

  type(vsleave_sup_inputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vsleave_sup_inputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vsleave_sup_inputs_c_alloc_init

! Links to type: "vsleave_sup_inputs" from module: "vsleave_sup_inputs_def_m" in file: "vsleave_sup_inputs_def.f90"
! Initializes only with no allocation
subroutine vsleave_sup_inputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  integer(c_int), pointer :: sl_nstokes_ptr
  ...
  fortran_type_f%sl_vsleave_datapath = ''
  transfer_struct_c%sl_vsleave_datapath_f_len = len(fortran_type_f%sl_vsleave_datapath)
  ...
  fortran_type_f%sl_nstokes = 0
  sl_nstokes_ptr => fortran_type_f%sl_nstokes
  transfer_struct_c%sl_nstokes = c_loc(sl_nstokes_ptr)
  inquire(iolength=transfer_struct_c%sl_nstokes_f_byte_size) fortran_type_f%sl_nstokes
#ifdef ifort
  transfer_struct_c%sl_nstokes_f_byte_size = transfer_struct_c%sl_nstokes_f_byte_size * 4
#endif
...
end subroutine vsleave_sup_inputs_c_init_only

subroutine vsleave_sup_inputs_c_destroy(fortran_type_c) bind(C)
  use vsleave_sup_inputs_def_m, only : vsleave_sup_inputs
  ...
  deallocate(fortran_type_f)
end subroutine vsleave_sup_inputs_c_destroy

subroutine vsleave_sup_inputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vsleave_sup_inputs_def_m, only : vsleave_sup_inputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vsleave_sup_inputs), pointer :: fortran_type_f_from
  type(vsleave_sup_inputs), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%sl_vsleave_datapath = fortran_type_f_from%sl_vsleave_datapath
  ...
  fortran_type_f_to%sl_nstokes = fortran_type_f_from%sl_nstokes
...
end subroutine vsleave_sup_inputs_c_copy

! Links to type: "vlidort_fixed_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_lincontrol_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lincontrol

  type(vlidort_fixed_lincontrol_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_lincontrol_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_lincontrol_c_alloc_init

! Links to type: "vlidort_fixed_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_lincontrol_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  integer(c_int), pointer :: ts_n_totalprofile_wfs_ptr
  ...
  fortran_type_f%ts_n_totalprofile_wfs = 0
  ts_n_totalprofile_wfs_ptr => fortran_type_f%ts_n_totalprofile_wfs
  transfer_struct_c%ts_n_totalprofile_wfs = c_loc(ts_n_totalprofile_wfs_ptr)
  inquire(iolength=transfer_struct_c%ts_n_totalprofile_wfs_f_byte_size) fortran_type_f%ts_n_totalprofile_wfs
#ifdef ifort
  transfer_struct_c%ts_n_totalprofile_wfs_f_byte_size = transfer_struct_c%ts_n_totalprofile_wfs_f_byte_size * 4
#endif
...
end subroutine vlidort_fixed_lincontrol_c_init_only

subroutine vlidort_fixed_lincontrol_c_destroy(fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lincontrol
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_lincontrol_c_destroy

subroutine vlidort_fixed_lincontrol_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lincontrol

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_lincontrol), pointer :: fortran_type_f_from
  type(vlidort_fixed_lincontrol), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%ts_n_totalprofile_wfs = fortran_type_f_from%ts_n_totalprofile_wfs
...
end subroutine vlidort_fixed_lincontrol_c_copy

! Links to type: "vlidort_fixed_linoptical" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_linoptical_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_linoptical

  type(vlidort_fixed_linoptical_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_linoptical_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_linoptical_c_alloc_init

! Links to type: "vlidort_fixed_linoptical" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_linoptical_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m
  use vlidort_pars_m
  ...
  real(c_double), dimension(:,:,:,:), pointer :: ts_l_greekmat_total_input_ptr
  real(c_double), dimension(:,:,:,:), pointer :: ts_l_fmatrix_up_ptr
  real(c_double), dimension(:,:,:,:), pointer :: ts_l_fmatrix_dn_ptr
  ...
  fortran_type_f%ts_l_greekmat_total_input = 0_fpk
  ts_l_greekmat_total_input_ptr => fortran_type_f%ts_l_greekmat_total_input
  transfer_struct_c%ts_l_greekmat_total_input = c_loc(ts_l_greekmat_total_input_ptr(&
    lbound(fortran_type_f%ts_l_greekmat_total_input,1),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,2),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,3),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,4)))
  inquire(iolength=transfer_struct_c%ts_l_greekmat_total_input_f_byte_size) fortran_type_f%ts_l_greekmat_total_input(&
    lbound(fortran_type_f%ts_l_greekmat_total_input,1),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,2),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,3),&
    lbound(fortran_type_f%ts_l_greekmat_total_input,4))
#ifdef ifort
  transfer_struct_c%ts_l_greekmat_total_input_f_byte_size = transfer_struct_c%ts_l_greekmat_total_input_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_l_greekmat_total_input_f_shapes(1) = size(fortran_type_f%ts_l_greekmat_total_input, 1)
  transfer_struct_c%ts_l_greekmat_total_input_f_shapes(2) = size(fortran_type_f%ts_l_greekmat_total_input, 2)
  transfer_struct_c%ts_l_greekmat_total_input_f_shapes(3) = size(fortran_type_f%ts_l_greekmat_total_input, 3)
  transfer_struct_c%ts_l_greekmat_total_input_f_shapes(4) = size(fortran_type_f%ts_l_greekmat_total_input, 4)
  
  
  fortran_type_f%ts_l_fmatrix_up = 0_fpk
  ts_l_fmatrix_up_ptr => fortran_type_f%ts_l_fmatrix_up
  transfer_struct_c%ts_l_fmatrix_up = c_loc(ts_l_fmatrix_up_ptr(&
    lbound(fortran_type_f%ts_l_fmatrix_up,1),&
    lbound(fortran_type_f%ts_l_fmatrix_up,2),&
    lbound(fortran_type_f%ts_l_fmatrix_up,3),&
    lbound(fortran_type_f%ts_l_fmatrix_up,4)))
  inquire(iolength=transfer_struct_c%ts_l_fmatrix_up_f_byte_size) fortran_type_f%ts_l_fmatrix_up(&
    lbound(fortran_type_f%ts_l_fmatrix_up,1),&
    lbound(fortran_type_f%ts_l_fmatrix_up,2),&
    lbound(fortran_type_f%ts_l_fmatrix_up,3),&
    lbound(fortran_type_f%ts_l_fmatrix_up,4))
#ifdef ifort
  transfer_struct_c%ts_l_fmatrix_up_f_byte_size = transfer_struct_c%ts_l_fmatrix_up_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_l_fmatrix_up_f_shapes(1) = size(fortran_type_f%ts_l_fmatrix_up, 1)
  transfer_struct_c%ts_l_fmatrix_up_f_shapes(2) = size(fortran_type_f%ts_l_fmatrix_up, 2)
  transfer_struct_c%ts_l_fmatrix_up_f_shapes(3) = size(fortran_type_f%ts_l_fmatrix_up, 3)
  transfer_struct_c%ts_l_fmatrix_up_f_shapes(4) = size(fortran_type_f%ts_l_fmatrix_up, 4)
  
  
  fortran_type_f%ts_l_fmatrix_dn = 0_fpk
  ts_l_fmatrix_dn_ptr => fortran_type_f%ts_l_fmatrix_dn
  transfer_struct_c%ts_l_fmatrix_dn = c_loc(ts_l_fmatrix_dn_ptr(&
    lbound(fortran_type_f%ts_l_fmatrix_dn,1),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,2),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,3),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,4)))
  inquire(iolength=transfer_struct_c%ts_l_fmatrix_dn_f_byte_size) fortran_type_f%ts_l_fmatrix_dn(&
    lbound(fortran_type_f%ts_l_fmatrix_dn,1),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,2),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,3),&
    lbound(fortran_type_f%ts_l_fmatrix_dn,4))
#ifdef ifort
  transfer_struct_c%ts_l_fmatrix_dn_f_byte_size = transfer_struct_c%ts_l_fmatrix_dn_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_l_fmatrix_dn_f_shapes(1) = size(fortran_type_f%ts_l_fmatrix_dn, 1)
  transfer_struct_c%ts_l_fmatrix_dn_f_shapes(2) = size(fortran_type_f%ts_l_fmatrix_dn, 2)
  transfer_struct_c%ts_l_fmatrix_dn_f_shapes(3) = size(fortran_type_f%ts_l_fmatrix_dn, 3)
  transfer_struct_c%ts_l_fmatrix_dn_f_shapes(4) = size(fortran_type_f%ts_l_fmatrix_dn, 4)
  
  
end subroutine vlidort_fixed_linoptical_c_init_only

subroutine vlidort_fixed_linoptical_c_destroy(fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_linoptical
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_linoptical_c_destroy

subroutine vlidort_fixed_linoptical_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_linoptical

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_linoptical), pointer :: fortran_type_f_from
  type(vlidort_fixed_linoptical), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%ts_l_greekmat_total_input = fortran_type_f_from%ts_l_greekmat_total_input
  fortran_type_f_to%ts_l_fmatrix_up = fortran_type_f_from%ts_l_fmatrix_up
  fortran_type_f_to%ts_l_fmatrix_dn = fortran_type_f_from%ts_l_fmatrix_dn
  

end subroutine vlidort_fixed_linoptical_c_copy

! Links to type: "vlidort_fixed_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_lininputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lininputs

  type(vlidort_fixed_lininputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_lininputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_lininputs_c_alloc_init

! Links to type: "vlidort_fixed_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_lininputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_fixed_lincontrol), pointer :: cont_ptr
  type(vlidort_fixed_linoptical), pointer :: optical_ptr
...
end subroutine vlidort_fixed_lininputs_c_init_only

subroutine vlidort_fixed_lininputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lininputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_lininputs_c_destroy

subroutine vlidort_fixed_lininputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_fixed_lininputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_lininputs), pointer :: fortran_type_f_from
  type(vlidort_fixed_lininputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_lininputs_c_copy

! Links to type: "vlidort_modified_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_lincontrol_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lincontrol

  type(vlidort_modified_lincontrol_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_lincontrol_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_lincontrol_c_alloc_init

! Links to type: "vlidort_modified_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_lincontrol_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_modified_lincontrol_c_init_only

subroutine vlidort_modified_lincontrol_c_destroy(fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lincontrol
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_lincontrol_c_destroy

subroutine vlidort_modified_lincontrol_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lincontrol

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_lincontrol), pointer :: fortran_type_f_from
  type(vlidort_modified_lincontrol), pointer :: fortran_type_f_to
...
end subroutine vlidort_modified_lincontrol_c_copy

! Links to type: "vlidort_modified_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_lininputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lininputs

  type(vlidort_modified_lininputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_lininputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_lininputs_c_alloc_init

! Links to type: "vlidort_modified_lininputs" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_lininputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_lininputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_modified_lincontrol), pointer :: mcont_ptr
...
end subroutine vlidort_modified_lininputs_c_init_only

subroutine vlidort_modified_lininputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lininputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_lininputs_c_destroy

subroutine vlidort_modified_lininputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_lininputs_def_m, only : vlidort_modified_lininputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_lininputs), pointer :: fortran_type_f_from
  type(vlidort_modified_lininputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_modified_lininputs_c_copy

! Links to type: "vlidort_lincol" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_lincol_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_lincol

  type(vlidort_lincol_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_lincol_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_lincol_c_alloc_init

! Links to type: "vlidort_lincol" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_lincol_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  real(c_double), dimension(:,:,:,:,:), pointer :: ts_meanst_diffuse_colwf_ptr
  real(c_double), dimension(:,:,:,:,:), pointer :: ts_flux_diffuse_colwf_ptr
  real(c_double), dimension(:,:,:,:), pointer :: ts_dnmeanst_direct_colwf_ptr
  ...
  fortran_type_f%ts_meanst_diffuse_colwf = 0_fpk
  ts_meanst_diffuse_colwf_ptr => fortran_type_f%ts_meanst_diffuse_colwf
  transfer_struct_c%ts_meanst_diffuse_colwf = c_loc(ts_meanst_diffuse_colwf_ptr(&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,4),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,5)))
  inquire(iolength=transfer_struct_c%ts_meanst_diffuse_colwf_f_byte_size) fortran_type_f%ts_meanst_diffuse_colwf(&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,4),&
    lbound(fortran_type_f%ts_meanst_diffuse_colwf,5))
#ifdef ifort
  transfer_struct_c%ts_meanst_diffuse_colwf_f_byte_size = transfer_struct_c%ts_meanst_diffuse_colwf_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_meanst_diffuse_colwf_f_shapes(1) = size(fortran_type_f%ts_meanst_diffuse_colwf, 1)
  transfer_struct_c%ts_meanst_diffuse_colwf_f_shapes(2) = size(fortran_type_f%ts_meanst_diffuse_colwf, 2)
  transfer_struct_c%ts_meanst_diffuse_colwf_f_shapes(3) = size(fortran_type_f%ts_meanst_diffuse_colwf, 3)
  transfer_struct_c%ts_meanst_diffuse_colwf_f_shapes(4) = size(fortran_type_f%ts_meanst_diffuse_colwf, 4)
  transfer_struct_c%ts_meanst_diffuse_colwf_f_shapes(5) = size(fortran_type_f%ts_meanst_diffuse_colwf, 5)
  ...
  transfer_struct_c%ts_flux_diffuse_colwf = c_loc(ts_flux_diffuse_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_flux_diffuse_colwf,5)))
  ...
  transfer_struct_c%ts_flux_diffuse_colwf_f_shapes(5) = size(fortran_type_f%ts_flux_diffuse_colwf, 5)
  
  
  fortran_type_f%ts_dnmeanst_direct_colwf = 0_fpk
  ts_dnmeanst_direct_colwf_ptr => fortran_type_f%ts_dnmeanst_direct_colwf
  transfer_struct_c%ts_dnmeanst_direct_colwf = c_loc(ts_dnmeanst_direct_colwf_ptr(&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,3),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,4)))
  inquire(iolength=transfer_struct_c%ts_dnmeanst_direct_colwf_f_byte_size) fortran_type_f%ts_dnmeanst_direct_colwf(&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,3),&
    lbound(fortran_type_f%ts_dnmeanst_direct_colwf,4))
#ifdef ifort
  transfer_struct_c%ts_dnmeanst_direct_colwf_f_byte_size = transfer_struct_c%ts_dnmeanst_direct_colwf_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_dnmeanst_direct_colwf_f_shapes(1) = size(fortran_type_f%ts_dnmeanst_direct_colwf, 1)
  transfer_struct_c%ts_dnmeanst_direct_colwf_f_shapes(2) = size(fortran_type_f%ts_dnmeanst_direct_colwf, 2)
  transfer_struct_c%ts_dnmeanst_direct_colwf_f_shapes(3) = size(fortran_type_f%ts_dnmeanst_direct_colwf, 3)
  transfer_struct_c%ts_dnmeanst_direct_colwf_f_shapes(4) = size(fortran_type_f%ts_dnmeanst_direct_colwf, 4)
  ...
  transfer_struct_c%ts_dnflux_direct_colwf = c_loc(ts_dnflux_direct_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_dnflux_direct_colwf,4)))
  ...
  transfer_struct_c%ts_dnflux_direct_colwf_f_shapes(4) = size(fortran_type_f%ts_dnflux_direct_colwf, 4)
  ...
  transfer_struct_c%ts_albmed_user_colwf = c_loc(ts_albmed_user_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_user_colwf,3)))
  ...
  transfer_struct_c%ts_albmed_user_colwf_f_shapes(3) = size(fortran_type_f%ts_albmed_user_colwf, 3)
  ...
  transfer_struct_c%ts_trnmed_user_colwf = c_loc(ts_trnmed_user_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_user_colwf,3)))
  ...
  transfer_struct_c%ts_trnmed_user_colwf_f_shapes(3) = size(fortran_type_f%ts_trnmed_user_colwf, 3)
  ...
  transfer_struct_c%ts_albmed_fluxes_colwf = c_loc(ts_albmed_fluxes_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_fluxes_colwf,3)))
  ...
  transfer_struct_c%ts_albmed_fluxes_colwf_f_shapes(3) = size(fortran_type_f%ts_albmed_fluxes_colwf, 3)
  ...
  transfer_struct_c%ts_trnmed_fluxes_colwf = c_loc(ts_trnmed_fluxes_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_fluxes_colwf,3)))
  ...
  transfer_struct_c%ts_trnmed_fluxes_colwf_f_shapes(3) = size(fortran_type_f%ts_trnmed_fluxes_colwf, 3)
  ...
  transfer_struct_c%ts_transbeam_colwf = c_loc(ts_transbeam_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_transbeam_colwf,3)))
  ...
  transfer_struct_c%ts_transbeam_colwf_f_shapes(3) = size(fortran_type_f%ts_transbeam_colwf, 3)
  ...
  transfer_struct_c%ts_planetary_transterm_colwf = c_loc(ts_planetary_transterm_colwf_ptr(&
    ...
    lbound(fortran_type_f%ts_planetary_transterm_colwf,3)))
  ...
  transfer_struct_c%ts_planetary_transterm_colwf_f_shapes(3) = size(fortran_type_f%ts_planetary_transterm_colwf, 3)
  ...
  transfer_struct_c%ts_lc_layer_mssts = c_loc(ts_lc_layer_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_lc_layer_mssts,4)))
  ...
  transfer_struct_c%ts_lc_layer_mssts_f_shapes(4) = size(fortran_type_f%ts_lc_layer_mssts, 4)
  ...
  transfer_struct_c%ts_lc_surf_mssts = c_loc(ts_lc_surf_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_lc_surf_mssts,3)))
  ...
  transfer_struct_c%ts_lc_surf_mssts_f_shapes(3) = size(fortran_type_f%ts_lc_surf_mssts, 3)
  
  
end subroutine vlidort_lincol_c_init_only

subroutine vlidort_lincol_c_destroy(fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_lincol
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_lincol_c_destroy

subroutine vlidort_lincol_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_lincol

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_lincol), pointer :: fortran_type_f_from
  type(vlidort_lincol), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_columnwf = fortran_type_f_from%ts_columnwf
  fortran_type_f_to%ts_meanst_diffuse_colwf = fortran_type_f_from%ts_meanst_diffuse_colwf
  fortran_type_f_to%ts_flux_diffuse_colwf = fortran_type_f_from%ts_flux_diffuse_colwf
  fortran_type_f_to%ts_dnmeanst_direct_colwf = fortran_type_f_from%ts_dnmeanst_direct_colwf
...
end subroutine vlidort_lincol_c_copy

! Links to type: "vlidort_linprof" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_linprof_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linprof

  type(vlidort_linprof_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linprof_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linprof_c_alloc_init

! Links to type: "vlidort_linprof" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_linprof_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m
  use vlidort_pars_m
  ...
  real(c_double), dimension(:,:,:,:,:,:), pointer :: ts_meanst_diffuse_profwf_ptr
  real(c_double), dimension(:,:,:,:,:,:), pointer :: ts_flux_diffuse_profwf_ptr
  real(c_double), dimension(:,:,:,:,:), pointer :: ts_dnmeanst_direct_profwf_ptr
  ...
  fortran_type_f%ts_meanst_diffuse_profwf = 0_fpk
  ts_meanst_diffuse_profwf_ptr => fortran_type_f%ts_meanst_diffuse_profwf
  transfer_struct_c%ts_meanst_diffuse_profwf = c_loc(ts_meanst_diffuse_profwf_ptr(&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,4),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,5),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,6)))
  inquire(iolength=transfer_struct_c%ts_meanst_diffuse_profwf_f_byte_size) fortran_type_f%ts_meanst_diffuse_profwf(&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,4),&
    ...
    lbound(fortran_type_f%ts_meanst_diffuse_profwf,6))
#ifdef ifort
  transfer_struct_c%ts_meanst_diffuse_profwf_f_byte_size = transfer_struct_c%ts_meanst_diffuse_profwf_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(1) = size(fortran_type_f%ts_meanst_diffuse_profwf, 1)
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(2) = size(fortran_type_f%ts_meanst_diffuse_profwf, 2)
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(3) = size(fortran_type_f%ts_meanst_diffuse_profwf, 3)
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(4) = size(fortran_type_f%ts_meanst_diffuse_profwf, 4)
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(5) = size(fortran_type_f%ts_meanst_diffuse_profwf, 5)
  transfer_struct_c%ts_meanst_diffuse_profwf_f_shapes(6) = size(fortran_type_f%ts_meanst_diffuse_profwf, 6)
  ...
  transfer_struct_c%ts_flux_diffuse_profwf = c_loc(ts_flux_diffuse_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_flux_diffuse_profwf,6)))
  ...
  transfer_struct_c%ts_flux_diffuse_profwf_f_shapes(6) = size(fortran_type_f%ts_flux_diffuse_profwf, 6)
  
  
  fortran_type_f%ts_dnmeanst_direct_profwf = 0_fpk
  ts_dnmeanst_direct_profwf_ptr => fortran_type_f%ts_dnmeanst_direct_profwf
  transfer_struct_c%ts_dnmeanst_direct_profwf = c_loc(ts_dnmeanst_direct_profwf_ptr(&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,3),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,4),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,5)))
  inquire(iolength=transfer_struct_c%ts_dnmeanst_direct_profwf_f_byte_size) fortran_type_f%ts_dnmeanst_direct_profwf(&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,3),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,4),&
    lbound(fortran_type_f%ts_dnmeanst_direct_profwf,5))
#ifdef ifort
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_byte_size = transfer_struct_c%ts_dnmeanst_direct_profwf_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_shapes(1) = size(fortran_type_f%ts_dnmeanst_direct_profwf, 1)
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_shapes(2) = size(fortran_type_f%ts_dnmeanst_direct_profwf, 2)
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_shapes(3) = size(fortran_type_f%ts_dnmeanst_direct_profwf, 3)
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_shapes(4) = size(fortran_type_f%ts_dnmeanst_direct_profwf, 4)
  transfer_struct_c%ts_dnmeanst_direct_profwf_f_shapes(5) = size(fortran_type_f%ts_dnmeanst_direct_profwf, 5)
  ...
  transfer_struct_c%ts_dnflux_direct_profwf = c_loc(ts_dnflux_direct_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_dnflux_direct_profwf,5)))
  ...
  transfer_struct_c%ts_dnflux_direct_profwf_f_shapes(5) = size(fortran_type_f%ts_dnflux_direct_profwf, 5)
  ...
  transfer_struct_c%ts_albmed_user_profwf = c_loc(ts_albmed_user_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_user_profwf,4)))
  ...
  transfer_struct_c%ts_albmed_user_profwf_f_shapes(4) = size(fortran_type_f%ts_albmed_user_profwf, 4)
  ...
  transfer_struct_c%ts_trnmed_user_profwf = c_loc(ts_trnmed_user_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_user_profwf,4)))
  ...
  transfer_struct_c%ts_trnmed_user_profwf_f_shapes(4) = size(fortran_type_f%ts_trnmed_user_profwf, 4)
  ...
  transfer_struct_c%ts_albmed_fluxes_profwf = c_loc(ts_albmed_fluxes_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_fluxes_profwf,4)))
  ...
  transfer_struct_c%ts_albmed_fluxes_profwf_f_shapes(4) = size(fortran_type_f%ts_albmed_fluxes_profwf, 4)
  ...
  transfer_struct_c%ts_trnmed_fluxes_profwf = c_loc(ts_trnmed_fluxes_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_fluxes_profwf,4)))
  ...
  transfer_struct_c%ts_trnmed_fluxes_profwf_f_shapes(4) = size(fortran_type_f%ts_trnmed_fluxes_profwf, 4)
  ...
  transfer_struct_c%ts_transbeam_profwf = c_loc(ts_transbeam_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_transbeam_profwf,4)))
  ...
  transfer_struct_c%ts_transbeam_profwf_f_shapes(4) = size(fortran_type_f%ts_transbeam_profwf, 4)
  ...
  transfer_struct_c%ts_planetary_transterm_profwf = c_loc(ts_planetary_transterm_profwf_ptr(&
    ...
    lbound(fortran_type_f%ts_planetary_transterm_profwf,4)))
  ...
  transfer_struct_c%ts_planetary_transterm_profwf_f_shapes(4) = size(fortran_type_f%ts_planetary_transterm_profwf, 4)
  ...
  transfer_struct_c%ts_lp_layer_mssts = c_loc(ts_lp_layer_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_lp_layer_mssts,5)))
  ...
  transfer_struct_c%ts_lp_layer_mssts_f_shapes(5) = size(fortran_type_f%ts_lp_layer_mssts, 5)
  ...
  transfer_struct_c%ts_lp_surf_mssts = c_loc(ts_lp_surf_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_lp_surf_mssts,4)))
  ...
  transfer_struct_c%ts_lp_surf_mssts_f_shapes(4) = size(fortran_type_f%ts_lp_surf_mssts, 4)
  
  
end subroutine vlidort_linprof_c_init_only

subroutine vlidort_linprof_c_destroy(fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linprof
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linprof_c_destroy

subroutine vlidort_linprof_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linprof

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linprof), pointer :: fortran_type_f_from
  type(vlidort_linprof), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_profilewf = fortran_type_f_from%ts_profilewf
  fortran_type_f_to%ts_meanst_diffuse_profwf = fortran_type_f_from%ts_meanst_diffuse_profwf
  fortran_type_f_to%ts_flux_diffuse_profwf = fortran_type_f_from%ts_flux_diffuse_profwf
  fortran_type_f_to%ts_dnmeanst_direct_profwf = fortran_type_f_from%ts_dnmeanst_direct_profwf
...
end subroutine vlidort_linprof_c_copy

! Links to type: "vlidort_linatmos" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_linatmos_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linatmos

  type(vlidort_linatmos_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linatmos_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linatmos_c_alloc_init

! Links to type: "vlidort_linatmos" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_linatmos_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m
  use vlidort_pars_m
  ...
  transfer_struct_c%ts_abbwfs_jacobians = c_loc(ts_abbwfs_jacobians_ptr(&
    ...
    lbound(fortran_type_f%ts_abbwfs_jacobians,5)))
  ...
  transfer_struct_c%ts_abbwfs_jacobians_f_shapes(5) = size(fortran_type_f%ts_abbwfs_jacobians, 5)
  ...
  transfer_struct_c%ts_abbwfs_fluxes = c_loc(ts_abbwfs_fluxes_ptr(&
    ...
    lbound(fortran_type_f%ts_abbwfs_fluxes,5)))
  ...
  transfer_struct_c%ts_abbwfs_fluxes_f_shapes(5) = size(fortran_type_f%ts_abbwfs_fluxes, 5)
  
  
end subroutine vlidort_linatmos_c_init_only

subroutine vlidort_linatmos_c_destroy(fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linatmos
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linatmos_c_destroy

subroutine vlidort_linatmos_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linatmos

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linatmos), pointer :: fortran_type_f_from
  type(vlidort_linatmos), pointer :: fortran_type_f_to
...
end subroutine vlidort_linatmos_c_copy

! Links to type: "vlidort_linsurf" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_linsurf_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linsurf

  type(vlidort_linsurf_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsurf_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsurf_c_alloc_init

! Links to type: "vlidort_linsurf" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsurf_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m
  use vlidort_pars_m
  ...
  real(c_double), dimension(:,:,:,:,:), pointer :: ts_meanst_diffuse_surfwf_ptr
  ...
  fortran_type_f%ts_meanst_diffuse_surfwf = 0_fpk
  ts_meanst_diffuse_surfwf_ptr => fortran_type_f%ts_meanst_diffuse_surfwf
  transfer_struct_c%ts_meanst_diffuse_surfwf = c_loc(ts_meanst_diffuse_surfwf_ptr(&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,4),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,5)))
  inquire(iolength=transfer_struct_c%ts_meanst_diffuse_surfwf_f_byte_size) fortran_type_f%ts_meanst_diffuse_surfwf(&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,1),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,2),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,3),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,4),&
    lbound(fortran_type_f%ts_meanst_diffuse_surfwf,5))
#ifdef ifort
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_byte_size = transfer_struct_c%ts_meanst_diffuse_surfwf_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_shapes(1) = size(fortran_type_f%ts_meanst_diffuse_surfwf, 1)
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_shapes(2) = size(fortran_type_f%ts_meanst_diffuse_surfwf, 2)
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_shapes(3) = size(fortran_type_f%ts_meanst_diffuse_surfwf, 3)
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_shapes(4) = size(fortran_type_f%ts_meanst_diffuse_surfwf, 4)
  transfer_struct_c%ts_meanst_diffuse_surfwf_f_shapes(5) = size(fortran_type_f%ts_meanst_diffuse_surfwf, 5)
  ...
  transfer_struct_c%ts_flux_diffuse_surfwf = c_loc(ts_flux_diffuse_surfwf_ptr(&
    ...
    lbound(fortran_type_f%ts_flux_diffuse_surfwf,5)))
  ...
  transfer_struct_c%ts_flux_diffuse_surfwf_f_shapes(5) = size(fortran_type_f%ts_flux_diffuse_surfwf, 5)
  ...
  transfer_struct_c%ts_ls_layer_mssts = c_loc(ts_ls_layer_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_layer_mssts,4)))
  ...
  transfer_struct_c%ts_ls_layer_mssts_f_shapes(4) = size(fortran_type_f%ts_ls_layer_mssts, 4)
  ...
  transfer_struct_c%ts_ls_surf_mssts = c_loc(ts_ls_surf_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_surf_mssts,3)))
  ...
  transfer_struct_c%ts_ls_surf_mssts_f_shapes(3) = size(fortran_type_f%ts_ls_surf_mssts, 3)
  ...
  transfer_struct_c%ts_sbbwfs_jacobians = c_loc(ts_sbbwfs_jacobians_ptr(&
    ...
    lbound(fortran_type_f%ts_sbbwfs_jacobians,4)))
  ...
  transfer_struct_c%ts_sbbwfs_jacobians_f_shapes(4) = size(fortran_type_f%ts_sbbwfs_jacobians, 4)
  ...
  transfer_struct_c%ts_sbbwfs_fluxes = c_loc(ts_sbbwfs_fluxes_ptr(&
    ...
    lbound(fortran_type_f%ts_sbbwfs_fluxes,4)))
  ...
  transfer_struct_c%ts_sbbwfs_fluxes_f_shapes(4) = size(fortran_type_f%ts_sbbwfs_fluxes, 4)
  
  
end subroutine vlidort_linsurf_c_init_only

subroutine vlidort_linsurf_c_destroy(fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linsurf
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsurf_c_destroy

subroutine vlidort_linsurf_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linsurf

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsurf), pointer :: fortran_type_f_from
  type(vlidort_linsurf), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_surfacewf = fortran_type_f_from%ts_surfacewf
  fortran_type_f_to%ts_meanst_diffuse_surfwf = fortran_type_f_from%ts_meanst_diffuse_surfwf
...
end subroutine vlidort_linsurf_c_copy

! Links to type: "vlidort_linoutputs" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_linoutputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linoutputs

  type(vlidort_linoutputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linoutputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linoutputs_c_alloc_init

! Links to type: "vlidort_linoutputs" from module: "vlidort_linoutputs_def_m" in file: "vlidort_lin_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_linoutputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_lincol), pointer :: col_ptr
  type(vlidort_linprof), pointer :: prof_ptr
  type(vlidort_linatmos), pointer :: atmos_ptr
  type(vlidort_linsurf), pointer :: surf_ptr
  ...
  col_ptr => fortran_type_f%col
  transfer_struct_c%col = c_loc(col_ptr)
  inquire(iolength=transfer_struct_c%col_f_byte_size) fortran_type_f%col
#ifdef ifort
  transfer_struct_c%col_f_byte_size = transfer_struct_c%col_f_byte_size * 4
#endif
  
  
  prof_ptr => fortran_type_f%prof
  transfer_struct_c%prof = c_loc(prof_ptr)
  inquire(iolength=transfer_struct_c%prof_f_byte_size) fortran_type_f%prof
#ifdef ifort
  transfer_struct_c%prof_f_byte_size = transfer_struct_c%prof_f_byte_size * 4
#endif
...
end subroutine vlidort_linoutputs_c_init_only

subroutine vlidort_linoutputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linoutputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linoutputs_c_destroy

subroutine vlidort_linoutputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linoutputs_def_m, only : vlidort_linoutputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linoutputs), pointer :: fortran_type_f_from
  type(vlidort_linoutputs), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%col = fortran_type_f_from%col
  fortran_type_f_to%prof = fortran_type_f_from%prof
  fortran_type_f_to%atmos = fortran_type_f_from%atmos
  fortran_type_f_to%surf = fortran_type_f_from%surf
  

end subroutine vlidort_linoutputs_c_copy

! Links to type: "vlidort_linsup_brdf" from module: "vlidort_linsup_brdf_def_m" in file: "vlidort_lin_sup_brdf_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_brdf_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_brdf_def_m, only : vlidort_linsup_brdf

  type(vlidort_linsup_brdf_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_brdf_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_brdf_c_alloc_init

! Links to type: "vlidort_linsup_brdf" from module: "vlidort_linsup_brdf_def_m" in file: "vlidort_lin_sup_brdf_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_brdf_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%ts_ls_exactdb_brdfunc = c_loc(ts_ls_exactdb_brdfunc_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_exactdb_brdfunc,5)))
  ...
  transfer_struct_c%ts_ls_exactdb_brdfunc_f_shapes(5) = size(fortran_type_f%ts_ls_exactdb_brdfunc, 5)
  ...
  transfer_struct_c%ts_ls_brdf_f_0 = c_loc(ts_ls_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_brdf_f_0,5)))
  ...
  transfer_struct_c%ts_ls_brdf_f_0_f_shapes(5) = size(fortran_type_f%ts_ls_brdf_f_0, 5)
  ...
  transfer_struct_c%ts_ls_brdf_f = c_loc(ts_ls_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_brdf_f,5)))
  ...
  transfer_struct_c%ts_ls_brdf_f_f_shapes(5) = size(fortran_type_f%ts_ls_brdf_f, 5)
  ...
  transfer_struct_c%ts_ls_user_brdf_f_0 = c_loc(ts_ls_user_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_user_brdf_f_0,5)))
  ...
  transfer_struct_c%ts_ls_user_brdf_f_0_f_shapes(5) = size(fortran_type_f%ts_ls_user_brdf_f_0, 5)
  ...
  transfer_struct_c%ts_ls_user_brdf_f = c_loc(ts_ls_user_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%ts_ls_user_brdf_f,5)))
  ...
  transfer_struct_c%ts_ls_user_brdf_f_f_shapes(5) = size(fortran_type_f%ts_ls_user_brdf_f, 5)
...
end subroutine vlidort_linsup_brdf_c_init_only

subroutine vlidort_linsup_brdf_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_brdf_def_m, only : vlidort_linsup_brdf
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_brdf_c_destroy

subroutine vlidort_linsup_brdf_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_brdf_def_m, only : vlidort_linsup_brdf

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_brdf), pointer :: fortran_type_f_from
  type(vlidort_linsup_brdf), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_brdf_c_copy

! Links to type: "vlidort_linsup_sleave" from module: "vlidort_linsup_sleave_def_m" in file: "vlidort_lin_sup_sleave_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_sleave_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_sleave_def_m, only : vlidort_linsup_sleave

  type(vlidort_linsup_sleave_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_sleave_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_sleave_c_alloc_init

! Links to type: "vlidort_linsup_sleave" from module: "vlidort_linsup_sleave_def_m" in file: "vlidort_lin_sup_sleave_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_sleave_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%ts_lssl_slterm_isotropic = c_loc(ts_lssl_slterm_isotropic_ptr(&
    ...
    lbound(fortran_type_f%ts_lssl_slterm_isotropic,3)))
  ...
  transfer_struct_c%ts_lssl_slterm_isotropic_f_shapes(3) = size(fortran_type_f%ts_lssl_slterm_isotropic, 3)
  ...
  transfer_struct_c%ts_lssl_slterm_userangles = c_loc(ts_lssl_slterm_userangles_ptr(&
    ...
    lbound(fortran_type_f%ts_lssl_slterm_userangles,5)))
  ...
  transfer_struct_c%ts_lssl_slterm_userangles_f_shapes(5) = size(fortran_type_f%ts_lssl_slterm_userangles, 5)
  ...
  transfer_struct_c%ts_lssl_slterm_f_0 = c_loc(ts_lssl_slterm_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_lssl_slterm_f_0,5)))
  ...
  transfer_struct_c%ts_lssl_slterm_f_0_f_shapes(5) = size(fortran_type_f%ts_lssl_slterm_f_0, 5)
  ...
  transfer_struct_c%ts_lssl_user_slterm_f_0 = c_loc(ts_lssl_user_slterm_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_lssl_user_slterm_f_0,5)))
  ...
  transfer_struct_c%ts_lssl_user_slterm_f_0_f_shapes(5) = size(fortran_type_f%ts_lssl_user_slterm_f_0, 5)
  
  
end subroutine vlidort_linsup_sleave_c_init_only

subroutine vlidort_linsup_sleave_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_sleave_def_m, only : vlidort_linsup_sleave
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_sleave_c_destroy

subroutine vlidort_linsup_sleave_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_sleave_def_m, only : vlidort_linsup_sleave

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_sleave), pointer :: fortran_type_f_from
  type(vlidort_linsup_sleave), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_sleave_c_copy

! Links to type: "vlidort_linsup_ss_col" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_ss_col_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_col

  type(vlidort_linsup_ss_col_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_ss_col_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_ss_col_c_alloc_init

! Links to type: "vlidort_linsup_ss_col" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_ss_col_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%ts_columnwf_ss = c_loc(ts_columnwf_ss_ptr(&
    ...
    lbound(fortran_type_f%ts_columnwf_ss,5)))
  ...
  transfer_struct_c%ts_columnwf_ss_f_shapes(5) = size(fortran_type_f%ts_columnwf_ss, 5)
  ...
  transfer_struct_c%ts_columnwf_db = c_loc(ts_columnwf_db_ptr(&
    ...
    lbound(fortran_type_f%ts_columnwf_db,4)))
  ...
  transfer_struct_c%ts_columnwf_db_f_shapes(4) = size(fortran_type_f%ts_columnwf_db, 4)
  
  
end subroutine vlidort_linsup_ss_col_c_init_only

subroutine vlidort_linsup_ss_col_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_col
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_ss_col_c_destroy

subroutine vlidort_linsup_ss_col_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_col

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_ss_col), pointer :: fortran_type_f_from
  type(vlidort_linsup_ss_col), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_ss_col_c_copy

! Links to type: "vlidort_linsup_ss_prof" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_ss_prof_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_prof

  type(vlidort_linsup_ss_prof_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_ss_prof_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_ss_prof_c_alloc_init

! Links to type: "vlidort_linsup_ss_prof" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_ss_prof_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m
  use vlidort_pars_m
  ...
  transfer_struct_c%ts_profilewf_ss = c_loc(ts_profilewf_ss_ptr(&
    ...
    lbound(fortran_type_f%ts_profilewf_ss,6)))
  ...
  transfer_struct_c%ts_profilewf_ss_f_shapes(6) = size(fortran_type_f%ts_profilewf_ss, 6)
  ...
  transfer_struct_c%ts_profilewf_db = c_loc(ts_profilewf_db_ptr(&
    ...
    lbound(fortran_type_f%ts_profilewf_db,5)))
  ...
  transfer_struct_c%ts_profilewf_db_f_shapes(5) = size(fortran_type_f%ts_profilewf_db, 5)
  
  
end subroutine vlidort_linsup_ss_prof_c_init_only

subroutine vlidort_linsup_ss_prof_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_prof
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_ss_prof_c_destroy

subroutine vlidort_linsup_ss_prof_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_prof

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_ss_prof), pointer :: fortran_type_f_from
  type(vlidort_linsup_ss_prof), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_ss_prof_c_copy

! Links to type: "vlidort_linsup_ss_surf" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_ss_surf_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_surf

  type(vlidort_linsup_ss_surf_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_ss_surf_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_ss_surf_c_alloc_init

! Links to type: "vlidort_linsup_ss_surf" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_ss_surf_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m
  use vlidort_pars_m
  ...
  transfer_struct_c%ts_surfacewf_db = c_loc(ts_surfacewf_db_ptr(&
    ...
    lbound(fortran_type_f%ts_surfacewf_db,4)))
  ...
  transfer_struct_c%ts_surfacewf_db_f_shapes(4) = size(fortran_type_f%ts_surfacewf_db, 4)
  
  
end subroutine vlidort_linsup_ss_surf_c_init_only

subroutine vlidort_linsup_ss_surf_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_surf
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_ss_surf_c_destroy

subroutine vlidort_linsup_ss_surf_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss_surf

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_ss_surf), pointer :: fortran_type_f_from
  type(vlidort_linsup_ss_surf), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_ss_surf_c_copy

! Links to type: "vlidort_linsup_ss" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_ss_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss

  type(vlidort_linsup_ss_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_ss_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_ss_c_alloc_init

! Links to type: "vlidort_linsup_ss" from module: "vlidort_linsup_ss_def_m" in file: "vlidort_lin_sup_ss_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_ss_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m
  use vlidort_pars_m
  ...
  type(vlidort_linsup_ss_col), pointer :: col_ptr
  type(vlidort_linsup_ss_prof), pointer :: prof_ptr
  type(vlidort_linsup_ss_surf), pointer :: surf_ptr
...
end subroutine vlidort_linsup_ss_c_init_only

subroutine vlidort_linsup_ss_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_ss_c_destroy

subroutine vlidort_linsup_ss_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_ss_def_m, only : vlidort_linsup_ss

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_ss), pointer :: fortran_type_f_from
  type(vlidort_linsup_ss), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_ss_c_copy

! Links to type: "vlidort_linsup_inout" from module: "vlidort_linsup_inout_def_m" in file: "vlidort_lin_sup_def.f90"
! Allocs and initializes type
subroutine vlidort_linsup_inout_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_linsup_inout_def_m, only : vlidort_linsup_inout

  type(vlidort_linsup_inout_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_linsup_inout_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_linsup_inout_c_alloc_init

! Links to type: "vlidort_linsup_inout" from module: "vlidort_linsup_inout_def_m" in file: "vlidort_lin_sup_def.f90"
! Initializes only with no allocation
subroutine vlidort_linsup_inout_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  type(vlidort_linsup_brdf), pointer :: brdf_ptr
  type(vlidort_linsup_ss), pointer :: ss_ptr
  type(vlidort_linsup_sleave), pointer :: sleave_ptr
...
end subroutine vlidort_linsup_inout_c_init_only

subroutine vlidort_linsup_inout_c_destroy(fortran_type_c) bind(C)
  use vlidort_linsup_inout_def_m, only : vlidort_linsup_inout
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_linsup_inout_c_destroy

subroutine vlidort_linsup_inout_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_linsup_inout_def_m, only : vlidort_linsup_inout

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_linsup_inout), pointer :: fortran_type_f_from
  type(vlidort_linsup_inout), pointer :: fortran_type_f_to
...
end subroutine vlidort_linsup_inout_c_copy

! Links to type: "vlidort_main_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_main_outputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_main_outputs

  type(vlidort_main_outputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_main_outputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_main_outputs_c_alloc_init

! Links to type: "vlidort_main_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_main_outputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  real(c_double), dimension(:,:,:,:), pointer :: ts_stokes_ptr
  real(c_double), dimension(:,:,:,:), pointer :: ts_meanst_diffuse_ptr
  real(c_double), dimension(:,:,:,:), pointer :: ts_flux_diffuse_ptr
  real(c_double), dimension(:,:,:), pointer :: ts_dnmeanst_direct_ptr
  ...
  integer(c_int), dimension(:), pointer :: ts_sza_offsets_ptr
  integer(c_int), dimension(:,:), pointer :: ts_vza_offsets_ptr
  integer(c_int), dimension(:), pointer :: ts_szd_offsets_ptr
  ...
  fortran_type_f%ts_stokes = 0_fpk
  ts_stokes_ptr => fortran_type_f%ts_stokes
  transfer_struct_c%ts_stokes = c_loc(ts_stokes_ptr(&
    lbound(fortran_type_f%ts_stokes,1),&
    lbound(fortran_type_f%ts_stokes,2),&
    lbound(fortran_type_f%ts_stokes,3),&
    lbound(fortran_type_f%ts_stokes,4)))
  inquire(iolength=transfer_struct_c%ts_stokes_f_byte_size) fortran_type_f%ts_stokes(&
    lbound(fortran_type_f%ts_stokes,1),&
    lbound(fortran_type_f%ts_stokes,2),&
    lbound(fortran_type_f%ts_stokes,3),&
    lbound(fortran_type_f%ts_stokes,4))
#ifdef ifort
  transfer_struct_c%ts_stokes_f_byte_size = transfer_struct_c%ts_stokes_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_stokes_f_shapes(1) = size(fortran_type_f%ts_stokes, 1)
  transfer_struct_c%ts_stokes_f_shapes(2) = size(fortran_type_f%ts_stokes, 2)
  transfer_struct_c%ts_stokes_f_shapes(3) = size(fortran_type_f%ts_stokes, 3)
  transfer_struct_c%ts_stokes_f_shapes(4) = size(fortran_type_f%ts_stokes, 4)
  
  
  fortran_type_f%ts_meanst_diffuse = 0_fpk
  ts_meanst_diffuse_ptr => fortran_type_f%ts_meanst_diffuse
  transfer_struct_c%ts_meanst_diffuse = c_loc(ts_meanst_diffuse_ptr(&
    lbound(fortran_type_f%ts_meanst_diffuse,1),&
    lbound(fortran_type_f%ts_meanst_diffuse,2),&
    lbound(fortran_type_f%ts_meanst_diffuse,3),&
    lbound(fortran_type_f%ts_meanst_diffuse,4)))
  inquire(iolength=transfer_struct_c%ts_meanst_diffuse_f_byte_size) fortran_type_f%ts_meanst_diffuse(&
    lbound(fortran_type_f%ts_meanst_diffuse,1),&
    lbound(fortran_type_f%ts_meanst_diffuse,2),&
    lbound(fortran_type_f%ts_meanst_diffuse,3),&
    lbound(fortran_type_f%ts_meanst_diffuse,4))
#ifdef ifort
  transfer_struct_c%ts_meanst_diffuse_f_byte_size = transfer_struct_c%ts_meanst_diffuse_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_meanst_diffuse_f_shapes(1) = size(fortran_type_f%ts_meanst_diffuse, 1)
  transfer_struct_c%ts_meanst_diffuse_f_shapes(2) = size(fortran_type_f%ts_meanst_diffuse, 2)
  transfer_struct_c%ts_meanst_diffuse_f_shapes(3) = size(fortran_type_f%ts_meanst_diffuse, 3)
  transfer_struct_c%ts_meanst_diffuse_f_shapes(4) = size(fortran_type_f%ts_meanst_diffuse, 4)
  ...
  transfer_struct_c%ts_flux_diffuse = c_loc(ts_flux_diffuse_ptr(&
    ...
    lbound(fortran_type_f%ts_flux_diffuse,4)))
  ...
  transfer_struct_c%ts_flux_diffuse_f_shapes(4) = size(fortran_type_f%ts_flux_diffuse, 4)
  
  
  fortran_type_f%ts_dnmeanst_direct = 0_fpk
  ts_dnmeanst_direct_ptr => fortran_type_f%ts_dnmeanst_direct
  transfer_struct_c%ts_dnmeanst_direct = c_loc(ts_dnmeanst_direct_ptr(&
    lbound(fortran_type_f%ts_dnmeanst_direct,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct,3)))
  inquire(iolength=transfer_struct_c%ts_dnmeanst_direct_f_byte_size) fortran_type_f%ts_dnmeanst_direct(&
    lbound(fortran_type_f%ts_dnmeanst_direct,1),&
    lbound(fortran_type_f%ts_dnmeanst_direct,2),&
    lbound(fortran_type_f%ts_dnmeanst_direct,3))
#ifdef ifort
  transfer_struct_c%ts_dnmeanst_direct_f_byte_size = transfer_struct_c%ts_dnmeanst_direct_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_dnmeanst_direct_f_shapes(1) = size(fortran_type_f%ts_dnmeanst_direct, 1)
  transfer_struct_c%ts_dnmeanst_direct_f_shapes(2) = size(fortran_type_f%ts_dnmeanst_direct, 2)
  transfer_struct_c%ts_dnmeanst_direct_f_shapes(3) = size(fortran_type_f%ts_dnmeanst_direct, 3)
  ...
  transfer_struct_c%ts_albmed_user = c_loc(ts_albmed_user_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_user,2)))
  ...
  transfer_struct_c%ts_albmed_user_f_shapes(2) = size(fortran_type_f%ts_albmed_user, 2)
  ...
  transfer_struct_c%ts_trnmed_user = c_loc(ts_trnmed_user_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_user,2)))
  ...
  transfer_struct_c%ts_trnmed_user_f_shapes(2) = size(fortran_type_f%ts_trnmed_user, 2)
  ...
  transfer_struct_c%ts_albmed_fluxes = c_loc(ts_albmed_fluxes_ptr(&
    ...
    lbound(fortran_type_f%ts_albmed_fluxes,2)))
  ...
  transfer_struct_c%ts_albmed_fluxes_f_shapes(2) = size(fortran_type_f%ts_albmed_fluxes, 2)
  ...
  transfer_struct_c%ts_trnmed_fluxes = c_loc(ts_trnmed_fluxes_ptr(&
    ...
    lbound(fortran_type_f%ts_trnmed_fluxes,2)))
  ...
  transfer_struct_c%ts_trnmed_fluxes_f_shapes(2) = size(fortran_type_f%ts_trnmed_fluxes, 2)
  ...
  transfer_struct_c%ts_planetary_transterm = c_loc(ts_planetary_transterm_ptr(&
    ...
    lbound(fortran_type_f%ts_planetary_transterm,2)))
  ...
  transfer_struct_c%ts_planetary_transterm_f_shapes(2) = size(fortran_type_f%ts_planetary_transterm, 2)
  ...
  transfer_struct_c%ts_layer_mssts = c_loc(ts_layer_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_layer_mssts,3)))
  ...
  transfer_struct_c%ts_layer_mssts_f_shapes(3) = size(fortran_type_f%ts_layer_mssts, 3)
  ...
  transfer_struct_c%ts_surf_mssts = c_loc(ts_surf_mssts_ptr(&
    ...
    lbound(fortran_type_f%ts_surf_mssts,2)))
  ...
  transfer_struct_c%ts_surf_mssts_f_shapes(2) = size(fortran_type_f%ts_surf_mssts, 2)
  ...
  transfer_struct_c%ts_contribs = c_loc(ts_contribs_ptr(&
    ...
    lbound(fortran_type_f%ts_contribs,3)))
  ...
  transfer_struct_c%ts_contribs_f_shapes(3) = size(fortran_type_f%ts_contribs, 3)
  ...
  fortran_type_f%ts_sza_offsets = 0
  ts_sza_offsets_ptr => fortran_type_f%ts_sza_offsets
  transfer_struct_c%ts_sza_offsets = c_loc(ts_sza_offsets_ptr(&
    lbound(fortran_type_f%ts_sza_offsets,1)))
  inquire(iolength=transfer_struct_c%ts_sza_offsets_f_byte_size) fortran_type_f%ts_sza_offsets(&
    lbound(fortran_type_f%ts_sza_offsets,1))
#ifdef ifort
  transfer_struct_c%ts_sza_offsets_f_byte_size = transfer_struct_c%ts_sza_offsets_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_sza_offsets_f_shapes(1) = size(fortran_type_f%ts_sza_offsets, 1)
  
  
  fortran_type_f%ts_vza_offsets = 0
  ts_vza_offsets_ptr => fortran_type_f%ts_vza_offsets
  transfer_struct_c%ts_vza_offsets = c_loc(ts_vza_offsets_ptr(&
    lbound(fortran_type_f%ts_vza_offsets,1),&
    lbound(fortran_type_f%ts_vza_offsets,2)))
  inquire(iolength=transfer_struct_c%ts_vza_offsets_f_byte_size) fortran_type_f%ts_vza_offsets(&
    lbound(fortran_type_f%ts_vza_offsets,1),&
    lbound(fortran_type_f%ts_vza_offsets,2))
#ifdef ifort
  transfer_struct_c%ts_vza_offsets_f_byte_size = transfer_struct_c%ts_vza_offsets_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_vza_offsets_f_shapes(1) = size(fortran_type_f%ts_vza_offsets, 1)
  transfer_struct_c%ts_vza_offsets_f_shapes(2) = size(fortran_type_f%ts_vza_offsets, 2)
  
  
  fortran_type_f%ts_szd_offsets = 0
  ts_szd_offsets_ptr => fortran_type_f%ts_szd_offsets
  transfer_struct_c%ts_szd_offsets = c_loc(ts_szd_offsets_ptr(&
    lbound(fortran_type_f%ts_szd_offsets,1)))
  inquire(iolength=transfer_struct_c%ts_szd_offsets_f_byte_size) fortran_type_f%ts_szd_offsets(&
    lbound(fortran_type_f%ts_szd_offsets,1))
#ifdef ifort
  transfer_struct_c%ts_szd_offsets_f_byte_size = transfer_struct_c%ts_szd_offsets_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_szd_offsets_f_shapes(1) = size(fortran_type_f%ts_szd_offsets, 1)
...
end subroutine vlidort_main_outputs_c_init_only

subroutine vlidort_main_outputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_main_outputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_main_outputs_c_destroy

subroutine vlidort_main_outputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_outputs_def_m, only : vlidort_main_outputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_main_outputs), pointer :: fortran_type_f_from
  type(vlidort_main_outputs), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_stokes = fortran_type_f_from%ts_stokes
  fortran_type_f_to%ts_meanst_diffuse = fortran_type_f_from%ts_meanst_diffuse
  fortran_type_f_to%ts_flux_diffuse = fortran_type_f_from%ts_flux_diffuse
  fortran_type_f_to%ts_dnmeanst_direct = fortran_type_f_from%ts_dnmeanst_direct
  ...
  fortran_type_f_to%ts_sza_offsets = fortran_type_f_from%ts_sza_offsets
  fortran_type_f_to%ts_vza_offsets = fortran_type_f_from%ts_vza_offsets
  fortran_type_f_to%ts_szd_offsets = fortran_type_f_from%ts_szd_offsets
  fortran_type_f_to%ts_solarbeam_boatrans = fortran_type_f_from%ts_solarbeam_boatrans
  

end subroutine vlidort_main_outputs_c_copy

! Links to type: "vlidort_wladjusted_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_wladjusted_outputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_wladjusted_outputs

  type(vlidort_wladjusted_outputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_wladjusted_outputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_wladjusted_outputs_c_alloc_init

! Links to type: "vlidort_wladjusted_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_wladjusted_outputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m
  use vlidort_pars_m
  ...
  transfer_struct_c%ts_wladjusted_isotropic = c_loc(ts_wladjusted_isotropic_ptr(&
    ...
    lbound(fortran_type_f%ts_wladjusted_isotropic,2)))
  ...
  transfer_struct_c%ts_wladjusted_isotropic_f_shapes(2) = size(fortran_type_f%ts_wladjusted_isotropic, 2)
  ...
  transfer_struct_c%ts_wladjusted_direct = c_loc(ts_wladjusted_direct_ptr(&
    ...
    lbound(fortran_type_f%ts_wladjusted_direct,4)))
  ...
  transfer_struct_c%ts_wladjusted_direct_f_shapes(4) = size(fortran_type_f%ts_wladjusted_direct, 4)
  ...
  transfer_struct_c%ts_wladjusted_f_ords_0 = c_loc(ts_wladjusted_f_ords_0_ptr(&
    ...
    lbound(fortran_type_f%ts_wladjusted_f_ords_0,4)))
  ...
  transfer_struct_c%ts_wladjusted_f_ords_0_f_shapes(4) = size(fortran_type_f%ts_wladjusted_f_ords_0, 4)
  ...
  transfer_struct_c%ts_wladjusted_f_user_0 = c_loc(ts_wladjusted_f_user_0_ptr(&
    ...
    lbound(fortran_type_f%ts_wladjusted_f_user_0,4)))
  ...
  transfer_struct_c%ts_wladjusted_f_user_0_f_shapes(4) = size(fortran_type_f%ts_wladjusted_f_user_0, 4)
  
  
end subroutine vlidort_wladjusted_outputs_c_init_only

subroutine vlidort_wladjusted_outputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_wladjusted_outputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_wladjusted_outputs_c_destroy

subroutine vlidort_wladjusted_outputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_outputs_def_m, only : vlidort_wladjusted_outputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_wladjusted_outputs), pointer :: fortran_type_f_from
  type(vlidort_wladjusted_outputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_wladjusted_outputs_c_copy

! Links to type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_exception_handling_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_exception_handling

  type(vlidort_exception_handling_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_exception_handling_c_alloc_init

! Links to type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_exception_handling_c_init_only

subroutine vlidort_exception_handling_c_destroy(fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_exception_handling
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_exception_handling_c_destroy

subroutine vlidort_exception_handling_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_outputs_def_m, only : vlidort_exception_handling

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_exception_handling), pointer :: fortran_type_f_from
  type(vlidort_exception_handling), pointer :: fortran_type_f_to
...
end subroutine vlidort_exception_handling_c_copy

! Links to type: "vlidort_input_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_input_exception_handling_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_input_exception_handling

  type(vlidort_input_exception_handling_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_input_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_input_exception_handling_c_alloc_init

! Links to type: "vlidort_input_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_input_exception_handling_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_input_exception_handling_c_init_only

subroutine vlidort_input_exception_handling_c_destroy(fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_input_exception_handling
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_input_exception_handling_c_destroy

subroutine vlidort_input_exception_handling_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_outputs_def_m, only : vlidort_input_exception_handling

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_input_exception_handling), pointer :: fortran_type_f_from
  type(vlidort_input_exception_handling), pointer :: fortran_type_f_to
...
end subroutine vlidort_input_exception_handling_c_copy

! Links to type: "vlidort_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Allocs and initializes type
subroutine vlidort_outputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_outputs

  type(vlidort_outputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_outputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_outputs_c_alloc_init

! Links to type: "vlidort_outputs" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_outputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_outputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_main_outputs), pointer :: main_ptr
  type(vlidort_wladjusted_outputs), pointer :: wlout_ptr
  type(vlidort_exception_handling), pointer :: status_ptr
...
end subroutine vlidort_outputs_c_init_only

subroutine vlidort_outputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_outputs_def_m, only : vlidort_outputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_outputs_c_destroy

subroutine vlidort_outputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_outputs_def_m, only : vlidort_outputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_outputs), pointer :: fortran_type_f_from
  type(vlidort_outputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_outputs_c_copy

! Links to type: "vlidort_sup_brdf" from module: "vlidort_sup_brdf_def_m" in file: "vlidort_sup_brdf_def.f90"
! Allocs and initializes type
subroutine vlidort_sup_brdf_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_sup_brdf_def_m, only : vlidort_sup_brdf

  type(vlidort_sup_brdf_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_sup_brdf_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_sup_brdf_c_alloc_init

! Links to type: "vlidort_sup_brdf" from module: "vlidort_sup_brdf_def_m" in file: "vlidort_sup_brdf_def.f90"
! Initializes only with no allocation
subroutine vlidort_sup_brdf_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%ts_exactdb_brdfunc = c_loc(ts_exactdb_brdfunc_ptr(&
    ...
    lbound(fortran_type_f%ts_exactdb_brdfunc,4)))
  ...
  transfer_struct_c%ts_exactdb_brdfunc_f_shapes(4) = size(fortran_type_f%ts_exactdb_brdfunc, 4)
  ...
  transfer_struct_c%ts_brdf_f_0 = c_loc(ts_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_brdf_f_0,4)))
  ...
  transfer_struct_c%ts_brdf_f_0_f_shapes(4) = size(fortran_type_f%ts_brdf_f_0, 4)
  ...
  transfer_struct_c%ts_brdf_f = c_loc(ts_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%ts_brdf_f,4)))
  ...
  transfer_struct_c%ts_brdf_f_f_shapes(4) = size(fortran_type_f%ts_brdf_f, 4)
  ...
  transfer_struct_c%ts_user_brdf_f_0 = c_loc(ts_user_brdf_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_user_brdf_f_0,4)))
  ...
  transfer_struct_c%ts_user_brdf_f_0_f_shapes(4) = size(fortran_type_f%ts_user_brdf_f_0, 4)
  ...
  transfer_struct_c%ts_user_brdf_f = c_loc(ts_user_brdf_f_ptr(&
    ...
    lbound(fortran_type_f%ts_user_brdf_f,4)))
  ...
  transfer_struct_c%ts_user_brdf_f_f_shapes(4) = size(fortran_type_f%ts_user_brdf_f, 4)
...
end subroutine vlidort_sup_brdf_c_init_only

subroutine vlidort_sup_brdf_c_destroy(fortran_type_c) bind(C)
  use vlidort_sup_brdf_def_m, only : vlidort_sup_brdf
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_sup_brdf_c_destroy

subroutine vlidort_sup_brdf_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_sup_brdf_def_m, only : vlidort_sup_brdf

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_sup_brdf), pointer :: fortran_type_f_from
  type(vlidort_sup_brdf), pointer :: fortran_type_f_to
...
end subroutine vlidort_sup_brdf_c_copy

! Links to type: "vlidort_sup_sleave" from module: "vlidort_sup_sleave_def_m" in file: "vlidort_sup_sleave_def.f90"
! Allocs and initializes type
subroutine vlidort_sup_sleave_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_sup_sleave_def_m, only : vlidort_sup_sleave

  type(vlidort_sup_sleave_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_sup_sleave_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_sup_sleave_c_alloc_init

! Links to type: "vlidort_sup_sleave" from module: "vlidort_sup_sleave_def_m" in file: "vlidort_sup_sleave_def.f90"
! Initializes only with no allocation
subroutine vlidort_sup_sleave_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  transfer_struct_c%ts_slterm_isotropic = c_loc(ts_slterm_isotropic_ptr(&
    ...
    lbound(fortran_type_f%ts_slterm_isotropic,2)))
  ...
  transfer_struct_c%ts_slterm_isotropic_f_shapes(2) = size(fortran_type_f%ts_slterm_isotropic, 2)
  ...
  transfer_struct_c%ts_slterm_userangles = c_loc(ts_slterm_userangles_ptr(&
    ...
    lbound(fortran_type_f%ts_slterm_userangles,4)))
  ...
  transfer_struct_c%ts_slterm_userangles_f_shapes(4) = size(fortran_type_f%ts_slterm_userangles, 4)
  ...
  transfer_struct_c%ts_slterm_f_0 = c_loc(ts_slterm_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_slterm_f_0,4)))
  ...
  transfer_struct_c%ts_slterm_f_0_f_shapes(4) = size(fortran_type_f%ts_slterm_f_0, 4)
  ...
  transfer_struct_c%ts_user_slterm_f_0 = c_loc(ts_user_slterm_f_0_ptr(&
    ...
    lbound(fortran_type_f%ts_user_slterm_f_0,4)))
  ...
  transfer_struct_c%ts_user_slterm_f_0_f_shapes(4) = size(fortran_type_f%ts_user_slterm_f_0, 4)
  
  
end subroutine vlidort_sup_sleave_c_init_only

subroutine vlidort_sup_sleave_c_destroy(fortran_type_c) bind(C)
  use vlidort_sup_sleave_def_m, only : vlidort_sup_sleave
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_sup_sleave_c_destroy

subroutine vlidort_sup_sleave_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_sup_sleave_def_m, only : vlidort_sup_sleave

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_sup_sleave), pointer :: fortran_type_f_from
  type(vlidort_sup_sleave), pointer :: fortran_type_f_to
...
end subroutine vlidort_sup_sleave_c_copy

! Links to type: "vlidort_sup_ss" from module: "vlidort_sup_ss_def_m" in file: "vlidort_sup_ss_def.f90"
! Allocs and initializes type
subroutine vlidort_sup_ss_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_sup_ss_def_m, only : vlidort_sup_ss

  type(vlidort_sup_ss_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_sup_ss_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_sup_ss_c_alloc_init

! Links to type: "vlidort_sup_ss" from module: "vlidort_sup_ss_def_m" in file: "vlidort_sup_ss_def.f90"
! Initializes only with no allocation
subroutine vlidort_sup_ss_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  real(c_double), dimension(:,:,:,:), pointer :: ts_stokes_ss_ptr
  real(c_double), dimension(:,:,:), pointer :: ts_stokes_db_ptr
  ...
  fortran_type_f%ts_stokes_ss = 0_fpk
  ts_stokes_ss_ptr => fortran_type_f%ts_stokes_ss
  transfer_struct_c%ts_stokes_ss = c_loc(ts_stokes_ss_ptr(&
    lbound(fortran_type_f%ts_stokes_ss,1),&
    lbound(fortran_type_f%ts_stokes_ss,2),&
    lbound(fortran_type_f%ts_stokes_ss,3),&
    lbound(fortran_type_f%ts_stokes_ss,4)))
  inquire(iolength=transfer_struct_c%ts_stokes_ss_f_byte_size) fortran_type_f%ts_stokes_ss(&
    lbound(fortran_type_f%ts_stokes_ss,1),&
    lbound(fortran_type_f%ts_stokes_ss,2),&
    lbound(fortran_type_f%ts_stokes_ss,3),&
    lbound(fortran_type_f%ts_stokes_ss,4))
#ifdef ifort
  transfer_struct_c%ts_stokes_ss_f_byte_size = transfer_struct_c%ts_stokes_ss_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_stokes_ss_f_shapes(1) = size(fortran_type_f%ts_stokes_ss, 1)
  transfer_struct_c%ts_stokes_ss_f_shapes(2) = size(fortran_type_f%ts_stokes_ss, 2)
  transfer_struct_c%ts_stokes_ss_f_shapes(3) = size(fortran_type_f%ts_stokes_ss, 3)
  transfer_struct_c%ts_stokes_ss_f_shapes(4) = size(fortran_type_f%ts_stokes_ss, 4)
  
  
  fortran_type_f%ts_stokes_db = 0_fpk
  ts_stokes_db_ptr => fortran_type_f%ts_stokes_db
  transfer_struct_c%ts_stokes_db = c_loc(ts_stokes_db_ptr(&
    lbound(fortran_type_f%ts_stokes_db,1),&
    lbound(fortran_type_f%ts_stokes_db,2),&
    lbound(fortran_type_f%ts_stokes_db,3)))
  inquire(iolength=transfer_struct_c%ts_stokes_db_f_byte_size) fortran_type_f%ts_stokes_db(&
    lbound(fortran_type_f%ts_stokes_db,1),&
    lbound(fortran_type_f%ts_stokes_db,2),&
    lbound(fortran_type_f%ts_stokes_db,3))
#ifdef ifort
  transfer_struct_c%ts_stokes_db_f_byte_size = transfer_struct_c%ts_stokes_db_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_stokes_db_f_shapes(1) = size(fortran_type_f%ts_stokes_db, 1)
  transfer_struct_c%ts_stokes_db_f_shapes(2) = size(fortran_type_f%ts_stokes_db, 2)
  transfer_struct_c%ts_stokes_db_f_shapes(3) = size(fortran_type_f%ts_stokes_db, 3)
  ...
  transfer_struct_c%ts_contribs_ss = c_loc(ts_contribs_ss_ptr(&
    ...
    lbound(fortran_type_f%ts_contribs_ss,3)))
  ...
  transfer_struct_c%ts_contribs_ss_f_shapes(3) = size(fortran_type_f%ts_contribs_ss, 3)
  
  
end subroutine vlidort_sup_ss_c_init_only

subroutine vlidort_sup_ss_c_destroy(fortran_type_c) bind(C)
  use vlidort_sup_ss_def_m, only : vlidort_sup_ss
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_sup_ss_c_destroy

subroutine vlidort_sup_ss_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_sup_ss_def_m, only : vlidort_sup_ss

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_sup_ss), pointer :: fortran_type_f_from
  type(vlidort_sup_ss), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_stokes_ss = fortran_type_f_from%ts_stokes_ss
  fortran_type_f_to%ts_stokes_db = fortran_type_f_from%ts_stokes_db
  fortran_type_f_to%ts_contribs_ss = fortran_type_f_from%ts_contribs_ss
  

end subroutine vlidort_sup_ss_c_copy

! Links to type: "vlidort_sup_inout" from module: "vlidort_sup_inout_def_m" in file: "vlidort_sup_def.f90"
! Allocs and initializes type
subroutine vlidort_sup_inout_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_sup_inout_def_m, only : vlidort_sup_inout

  type(vlidort_sup_inout_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_sup_inout_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_sup_inout_c_alloc_init

! Links to type: "vlidort_sup_inout" from module: "vlidort_sup_inout_def_m" in file: "vlidort_sup_def.f90"
! Initializes only with no allocation
subroutine vlidort_sup_inout_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  type(vlidort_sup_brdf), pointer :: brdf_ptr
  type(vlidort_sup_ss), pointer :: ss_ptr
  type(vlidort_sup_sleave), pointer :: sleave_ptr
...
end subroutine vlidort_sup_inout_c_init_only

subroutine vlidort_sup_inout_c_destroy(fortran_type_c) bind(C)
  use vlidort_sup_inout_def_m, only : vlidort_sup_inout
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_sup_inout_c_destroy

subroutine vlidort_sup_inout_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_sup_inout_def_m, only : vlidort_sup_inout

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_sup_inout), pointer :: fortran_type_f_from
  type(vlidort_sup_inout), pointer :: fortran_type_f_to
...
end subroutine vlidort_sup_inout_c_copy

! Links to type: "vlidort_fixed_boolean" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_boolean_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_boolean

  type(vlidort_fixed_boolean_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_boolean_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_boolean_c_alloc_init

! Links to type: "vlidort_fixed_boolean" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_boolean_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  ...
  logical(kind=4), pointer :: ts_do_lambertian_surface_ptr
  logical(kind=4), pointer :: ts_do_specialist_option_1_ptr
  logical(kind=4), pointer :: ts_do_specialist_option_2_ptr
  logical(kind=4), pointer :: ts_do_specialist_option_3_ptr
  ...
  logical(kind=4), pointer :: ts_do_fourier0_nstokes2_ptr
  ...
  fortran_type_f%ts_do_lambertian_surface = .FALSE.
  ts_do_lambertian_surface_ptr => fortran_type_f%ts_do_lambertian_surface
  transfer_struct_c%ts_do_lambertian_surface = c_loc(ts_do_lambertian_surface_ptr)
  inquire(iolength=transfer_struct_c%ts_do_lambertian_surface_f_byte_size) fortran_type_f%ts_do_lambertian_surface
#ifdef ifort
  transfer_struct_c%ts_do_lambertian_surface_f_byte_size = transfer_struct_c%ts_do_lambertian_surface_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_do_specialist_option_1 = .FALSE.
  ts_do_specialist_option_1_ptr => fortran_type_f%ts_do_specialist_option_1
  transfer_struct_c%ts_do_specialist_option_1 = c_loc(ts_do_specialist_option_1_ptr)
  inquire(iolength=transfer_struct_c%ts_do_specialist_option_1_f_byte_size) fortran_type_f%ts_do_specialist_option_1
#ifdef ifort
  transfer_struct_c%ts_do_specialist_option_1_f_byte_size = transfer_struct_c%ts_do_specialist_option_1_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_do_specialist_option_2 = .FALSE.
  ts_do_specialist_option_2_ptr => fortran_type_f%ts_do_specialist_option_2
  transfer_struct_c%ts_do_specialist_option_2 = c_loc(ts_do_specialist_option_2_ptr)
  inquire(iolength=transfer_struct_c%ts_do_specialist_option_2_f_byte_size) fortran_type_f%ts_do_specialist_option_2
#ifdef ifort
  transfer_struct_c%ts_do_specialist_option_2_f_byte_size = transfer_struct_c%ts_do_specialist_option_2_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_do_specialist_option_3 = .FALSE.
  ts_do_specialist_option_3_ptr => fortran_type_f%ts_do_specialist_option_3
  transfer_struct_c%ts_do_specialist_option_3 = c_loc(ts_do_specialist_option_3_ptr)
  inquire(iolength=transfer_struct_c%ts_do_specialist_option_3_f_byte_size) fortran_type_f%ts_do_specialist_option_3
#ifdef ifort
  transfer_struct_c%ts_do_specialist_option_3_f_byte_size = transfer_struct_c%ts_do_specialist_option_3_f_byte_size * 4
#endif
  ...
  fortran_type_f%ts_do_fourier0_nstokes2 = .FALSE.
  ts_do_fourier0_nstokes2_ptr => fortran_type_f%ts_do_fourier0_nstokes2
  transfer_struct_c%ts_do_fourier0_nstokes2 = c_loc(ts_do_fourier0_nstokes2_ptr)
  inquire(iolength=transfer_struct_c%ts_do_fourier0_nstokes2_f_byte_size) fortran_type_f%ts_do_fourier0_nstokes2
#ifdef ifort
  transfer_struct_c%ts_do_fourier0_nstokes2_f_byte_size = transfer_struct_c%ts_do_fourier0_nstokes2_f_byte_size * 4
#endif
  
  
  
end subroutine vlidort_fixed_boolean_c_init_only

subroutine vlidort_fixed_boolean_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_boolean
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_boolean_c_destroy

subroutine vlidort_fixed_boolean_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_boolean

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_boolean), pointer :: fortran_type_f_from
  type(vlidort_fixed_boolean), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%ts_do_lambertian_surface = fortran_type_f_from%ts_do_lambertian_surface
  fortran_type_f_to%ts_do_specialist_option_1 = fortran_type_f_from%ts_do_specialist_option_1
  fortran_type_f_to%ts_do_specialist_option_2 = fortran_type_f_from%ts_do_specialist_option_2
  fortran_type_f_to%ts_do_specialist_option_3 = fortran_type_f_from%ts_do_specialist_option_3
  ...
  fortran_type_f_to%ts_do_fourier0_nstokes2 = fortran_type_f_from%ts_do_fourier0_nstokes2
  

end subroutine vlidort_fixed_boolean_c_copy

! Links to type: "vlidort_fixed_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_control_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_control

  type(vlidort_fixed_control_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_control_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_control_c_alloc_init

! Links to type: "vlidort_fixed_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_control_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  integer(c_int), pointer :: ts_nstokes_ptr
  ...
  real(c_double), pointer :: ts_vlidort_accuracy_ptr
  real(c_double), pointer :: ts_asymtx_tolerance_ptr
  integer(c_int), pointer :: ts_nlayers_noms_ptr
  integer(c_int), pointer :: ts_nlayers_cutoff_ptr
  ...
  fortran_type_f%ts_nstokes = 0
  ts_nstokes_ptr => fortran_type_f%ts_nstokes
  transfer_struct_c%ts_nstokes = c_loc(ts_nstokes_ptr)
  inquire(iolength=transfer_struct_c%ts_nstokes_f_byte_size) fortran_type_f%ts_nstokes
#ifdef ifort
  transfer_struct_c%ts_nstokes_f_byte_size = transfer_struct_c%ts_nstokes_f_byte_size * 4
#endif
  ...
  fortran_type_f%ts_vlidort_accuracy = 0_fpk
  ts_vlidort_accuracy_ptr => fortran_type_f%ts_vlidort_accuracy
  transfer_struct_c%ts_vlidort_accuracy = c_loc(ts_vlidort_accuracy_ptr)
  inquire(iolength=transfer_struct_c%ts_vlidort_accuracy_f_byte_size) fortran_type_f%ts_vlidort_accuracy
#ifdef ifort
  transfer_struct_c%ts_vlidort_accuracy_f_byte_size = transfer_struct_c%ts_vlidort_accuracy_f_byte_size * 4
#endif
  ...
  fortran_type_f%ts_nlayers_noms = 0
  ts_nlayers_noms_ptr => fortran_type_f%ts_nlayers_noms
  transfer_struct_c%ts_nlayers_noms = c_loc(ts_nlayers_noms_ptr)
  inquire(iolength=transfer_struct_c%ts_nlayers_noms_f_byte_size) fortran_type_f%ts_nlayers_noms
#ifdef ifort
  transfer_struct_c%ts_nlayers_noms_f_byte_size = transfer_struct_c%ts_nlayers_noms_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_nlayers_cutoff = 0
  ts_nlayers_cutoff_ptr => fortran_type_f%ts_nlayers_cutoff
  transfer_struct_c%ts_nlayers_cutoff = c_loc(ts_nlayers_cutoff_ptr)
  inquire(iolength=transfer_struct_c%ts_nlayers_cutoff_f_byte_size) fortran_type_f%ts_nlayers_cutoff
#ifdef ifort
  transfer_struct_c%ts_nlayers_cutoff_f_byte_size = transfer_struct_c%ts_nlayers_cutoff_f_byte_size * 4
#endif
...
end subroutine vlidort_fixed_control_c_init_only

subroutine vlidort_fixed_control_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_control
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_control_c_destroy

subroutine vlidort_fixed_control_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_control

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_control), pointer :: fortran_type_f_from
  type(vlidort_fixed_control), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_taylor_order = fortran_type_f_from%ts_taylor_order
  fortran_type_f_to%ts_nstokes = fortran_type_f_from%ts_nstokes
  ...
  fortran_type_f_to%ts_vlidort_accuracy = fortran_type_f_from%ts_vlidort_accuracy
  fortran_type_f_to%ts_asymtx_tolerance = fortran_type_f_from%ts_asymtx_tolerance
  fortran_type_f_to%ts_nlayers_noms = fortran_type_f_from%ts_nlayers_noms
  fortran_type_f_to%ts_nlayers_cutoff = fortran_type_f_from%ts_nlayers_cutoff
...
end subroutine vlidort_fixed_control_c_copy

! Links to type: "vlidort_fixed_sunrays" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_sunrays_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_sunrays

  type(vlidort_fixed_sunrays_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_sunrays_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_sunrays_c_alloc_init

! Links to type: "vlidort_fixed_sunrays" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_sunrays_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_fixed_sunrays_c_init_only

subroutine vlidort_fixed_sunrays_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_sunrays
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_sunrays_c_destroy

subroutine vlidort_fixed_sunrays_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_sunrays

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_sunrays), pointer :: fortran_type_f_from
  type(vlidort_fixed_sunrays), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_sunrays_c_copy

! Links to type: "vlidort_fixed_uservalues" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_uservalues_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_uservalues

  type(vlidort_fixed_uservalues_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_uservalues_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_uservalues_c_alloc_init

! Links to type: "vlidort_fixed_uservalues" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_uservalues_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_fixed_uservalues_c_init_only

subroutine vlidort_fixed_uservalues_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_uservalues
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_uservalues_c_destroy

subroutine vlidort_fixed_uservalues_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_uservalues

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_uservalues), pointer :: fortran_type_f_from
  type(vlidort_fixed_uservalues), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_uservalues_c_copy

! Links to type: "vlidort_fixed_chapman" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_chapman_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_chapman

  type(vlidort_fixed_chapman_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_chapman_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_chapman_c_alloc_init

! Links to type: "vlidort_fixed_chapman" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_chapman_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_fixed_chapman_c_init_only

subroutine vlidort_fixed_chapman_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_chapman
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_chapman_c_destroy

subroutine vlidort_fixed_chapman_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_chapman

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_chapman), pointer :: fortran_type_f_from
  type(vlidort_fixed_chapman), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_chapman_c_copy

! Links to type: "vlidort_fixed_optical" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_optical_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_optical

  type(vlidort_fixed_optical_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_optical_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_optical_c_alloc_init

! Links to type: "vlidort_fixed_optical" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_optical_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  real(c_double), dimension(:,:,:), pointer :: ts_greekmat_total_input_ptr
  real(c_double), dimension(:,:,:), pointer :: ts_fmatrix_up_ptr
  real(c_double), dimension(:,:,:), pointer :: ts_fmatrix_dn_ptr
  ...
  fortran_type_f%ts_greekmat_total_input = 0_fpk
  ts_greekmat_total_input_ptr => fortran_type_f%ts_greekmat_total_input
  transfer_struct_c%ts_greekmat_total_input = c_loc(ts_greekmat_total_input_ptr(&
    lbound(fortran_type_f%ts_greekmat_total_input,1),&
    lbound(fortran_type_f%ts_greekmat_total_input,2),&
    lbound(fortran_type_f%ts_greekmat_total_input,3)))
  inquire(iolength=transfer_struct_c%ts_greekmat_total_input_f_byte_size) fortran_type_f%ts_greekmat_total_input(&
    lbound(fortran_type_f%ts_greekmat_total_input,1),&
    lbound(fortran_type_f%ts_greekmat_total_input,2),&
    lbound(fortran_type_f%ts_greekmat_total_input,3))
#ifdef ifort
  transfer_struct_c%ts_greekmat_total_input_f_byte_size = transfer_struct_c%ts_greekmat_total_input_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_greekmat_total_input_f_shapes(1) = size(fortran_type_f%ts_greekmat_total_input, 1)
  transfer_struct_c%ts_greekmat_total_input_f_shapes(2) = size(fortran_type_f%ts_greekmat_total_input, 2)
  transfer_struct_c%ts_greekmat_total_input_f_shapes(3) = size(fortran_type_f%ts_greekmat_total_input, 3)
  
  
  fortran_type_f%ts_fmatrix_up = 0_fpk
  ts_fmatrix_up_ptr => fortran_type_f%ts_fmatrix_up
  transfer_struct_c%ts_fmatrix_up = c_loc(ts_fmatrix_up_ptr(&
    lbound(fortran_type_f%ts_fmatrix_up,1),&
    lbound(fortran_type_f%ts_fmatrix_up,2),&
    lbound(fortran_type_f%ts_fmatrix_up,3)))
  inquire(iolength=transfer_struct_c%ts_fmatrix_up_f_byte_size) fortran_type_f%ts_fmatrix_up(&
    lbound(fortran_type_f%ts_fmatrix_up,1),&
    lbound(fortran_type_f%ts_fmatrix_up,2),&
    lbound(fortran_type_f%ts_fmatrix_up,3))
#ifdef ifort
  transfer_struct_c%ts_fmatrix_up_f_byte_size = transfer_struct_c%ts_fmatrix_up_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_fmatrix_up_f_shapes(1) = size(fortran_type_f%ts_fmatrix_up, 1)
  transfer_struct_c%ts_fmatrix_up_f_shapes(2) = size(fortran_type_f%ts_fmatrix_up, 2)
  transfer_struct_c%ts_fmatrix_up_f_shapes(3) = size(fortran_type_f%ts_fmatrix_up, 3)
  
  
  fortran_type_f%ts_fmatrix_dn = 0_fpk
  ts_fmatrix_dn_ptr => fortran_type_f%ts_fmatrix_dn
  transfer_struct_c%ts_fmatrix_dn = c_loc(ts_fmatrix_dn_ptr(&
    lbound(fortran_type_f%ts_fmatrix_dn,1),&
    lbound(fortran_type_f%ts_fmatrix_dn,2),&
    lbound(fortran_type_f%ts_fmatrix_dn,3)))
  inquire(iolength=transfer_struct_c%ts_fmatrix_dn_f_byte_size) fortran_type_f%ts_fmatrix_dn(&
    lbound(fortran_type_f%ts_fmatrix_dn,1),&
    lbound(fortran_type_f%ts_fmatrix_dn,2),&
    lbound(fortran_type_f%ts_fmatrix_dn,3))
#ifdef ifort
  transfer_struct_c%ts_fmatrix_dn_f_byte_size = transfer_struct_c%ts_fmatrix_dn_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_fmatrix_dn_f_shapes(1) = size(fortran_type_f%ts_fmatrix_dn, 1)
  transfer_struct_c%ts_fmatrix_dn_f_shapes(2) = size(fortran_type_f%ts_fmatrix_dn, 2)
  transfer_struct_c%ts_fmatrix_dn_f_shapes(3) = size(fortran_type_f%ts_fmatrix_dn, 3)
...
end subroutine vlidort_fixed_optical_c_init_only

subroutine vlidort_fixed_optical_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_optical
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_optical_c_destroy

subroutine vlidort_fixed_optical_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_optical

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_optical), pointer :: fortran_type_f_from
  type(vlidort_fixed_optical), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_deltau_vert_input = fortran_type_f_from%ts_deltau_vert_input
  fortran_type_f_to%ts_greekmat_total_input = fortran_type_f_from%ts_greekmat_total_input
  fortran_type_f_to%ts_fmatrix_up = fortran_type_f_from%ts_fmatrix_up
  fortran_type_f_to%ts_fmatrix_dn = fortran_type_f_from%ts_fmatrix_dn
...
end subroutine vlidort_fixed_optical_c_copy

! Links to type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_write_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_write

  type(vlidort_fixed_write_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_write_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_write_c_alloc_init

! Links to type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_write_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_fixed_write_c_init_only

subroutine vlidort_fixed_write_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_write
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_write_c_destroy

subroutine vlidort_fixed_write_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_write

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_write), pointer :: fortran_type_f_from
  type(vlidort_fixed_write), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_write_c_copy

! Links to type: "vlidort_fixed_inputs" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_fixed_inputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_inputs

  type(vlidort_fixed_inputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_fixed_inputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_fixed_inputs_c_alloc_init

! Links to type: "vlidort_fixed_inputs" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_fixed_inputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_fixed_boolean), pointer :: bool_ptr
  type(vlidort_fixed_control), pointer :: cont_ptr
  type(vlidort_fixed_sunrays), pointer :: sunrays_ptr
  type(vlidort_fixed_uservalues), pointer :: userval_ptr
  type(vlidort_fixed_chapman), pointer :: chapman_ptr
  type(vlidort_fixed_optical), pointer :: optical_ptr
  type(vlidort_fixed_write), pointer :: write_ptr
...
end subroutine vlidort_fixed_inputs_c_init_only

subroutine vlidort_fixed_inputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_inputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_fixed_inputs_c_destroy

subroutine vlidort_fixed_inputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_fixed_inputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_fixed_inputs), pointer :: fortran_type_f_from
  type(vlidort_fixed_inputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_fixed_inputs_c_copy

! Links to type: "vlidort_modified_boolean" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_boolean_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_boolean

  type(vlidort_modified_boolean_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_boolean_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_boolean_c_alloc_init

! Links to type: "vlidort_modified_boolean" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_boolean_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  logical(kind=4), pointer :: ts_do_sscorr_usefmat_ptr
  ...
  logical(kind=4), pointer :: ts_do_classical_solution_ptr
  ...
  logical(kind=4), pointer :: ts_do_user_vzangles_ptr
  ...
  fortran_type_f%ts_do_sscorr_usefmat = .FALSE.
  ts_do_sscorr_usefmat_ptr => fortran_type_f%ts_do_sscorr_usefmat
  transfer_struct_c%ts_do_sscorr_usefmat = c_loc(ts_do_sscorr_usefmat_ptr)
  inquire(iolength=transfer_struct_c%ts_do_sscorr_usefmat_f_byte_size) fortran_type_f%ts_do_sscorr_usefmat
#ifdef ifort
  transfer_struct_c%ts_do_sscorr_usefmat_f_byte_size = transfer_struct_c%ts_do_sscorr_usefmat_f_byte_size * 4
#endif
  ...
  fortran_type_f%ts_do_classical_solution = .FALSE.
  ts_do_classical_solution_ptr => fortran_type_f%ts_do_classical_solution
  transfer_struct_c%ts_do_classical_solution = c_loc(ts_do_classical_solution_ptr)
  inquire(iolength=transfer_struct_c%ts_do_classical_solution_f_byte_size) fortran_type_f%ts_do_classical_solution
#ifdef ifort
  transfer_struct_c%ts_do_classical_solution_f_byte_size = transfer_struct_c%ts_do_classical_solution_f_byte_size * 4
#endif
  ...
  fortran_type_f%ts_do_user_vzangles = .FALSE.
  ts_do_user_vzangles_ptr => fortran_type_f%ts_do_user_vzangles
  transfer_struct_c%ts_do_user_vzangles = c_loc(ts_do_user_vzangles_ptr)
  inquire(iolength=transfer_struct_c%ts_do_user_vzangles_f_byte_size) fortran_type_f%ts_do_user_vzangles
#ifdef ifort
  transfer_struct_c%ts_do_user_vzangles_f_byte_size = transfer_struct_c%ts_do_user_vzangles_f_byte_size * 4
#endif
...
end subroutine vlidort_modified_boolean_c_init_only

subroutine vlidort_modified_boolean_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_boolean
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_boolean_c_destroy

subroutine vlidort_modified_boolean_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_boolean

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_boolean), pointer :: fortran_type_f_from
  type(vlidort_modified_boolean), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%ts_do_sscorr_usefmat = fortran_type_f_from%ts_do_sscorr_usefmat
  ...
  fortran_type_f_to%ts_do_classical_solution = fortran_type_f_from%ts_do_classical_solution
  ...
  fortran_type_f_to%ts_do_user_vzangles = fortran_type_f_from%ts_do_user_vzangles
...
end subroutine vlidort_modified_boolean_c_copy

! Links to type: "vlidort_modified_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_control_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_control

  type(vlidort_modified_control_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_control_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_control_c_alloc_init

! Links to type: "vlidort_modified_control" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_control_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  integer(c_int), pointer :: ts_ngreek_moments_input_ptr
  ...
  fortran_type_f%ts_ngreek_moments_input = 0
  ts_ngreek_moments_input_ptr => fortran_type_f%ts_ngreek_moments_input
  transfer_struct_c%ts_ngreek_moments_input = c_loc(ts_ngreek_moments_input_ptr)
  inquire(iolength=transfer_struct_c%ts_ngreek_moments_input_f_byte_size) fortran_type_f%ts_ngreek_moments_input
#ifdef ifort
  transfer_struct_c%ts_ngreek_moments_input_f_byte_size = transfer_struct_c%ts_ngreek_moments_input_f_byte_size * 4
#endif
  
  
  
end subroutine vlidort_modified_control_c_init_only

subroutine vlidort_modified_control_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_control
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_control_c_destroy

subroutine vlidort_modified_control_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_control

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_control), pointer :: fortran_type_f_from
  type(vlidort_modified_control), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_ngreek_moments_input = fortran_type_f_from%ts_ngreek_moments_input
  

end subroutine vlidort_modified_control_c_copy

! Links to type: "vlidort_modified_sunrays" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_sunrays_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_sunrays

  type(vlidort_modified_sunrays_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_sunrays_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_sunrays_c_alloc_init

! Links to type: "vlidort_modified_sunrays" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_sunrays_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  integer(c_int), pointer :: ts_n_szangles_ptr
  real(c_double), dimension(:), pointer :: ts_szangles_ptr
  ...
  fortran_type_f%ts_n_szangles = 0
  ts_n_szangles_ptr => fortran_type_f%ts_n_szangles
  transfer_struct_c%ts_n_szangles = c_loc(ts_n_szangles_ptr)
  inquire(iolength=transfer_struct_c%ts_n_szangles_f_byte_size) fortran_type_f%ts_n_szangles
#ifdef ifort
  transfer_struct_c%ts_n_szangles_f_byte_size = transfer_struct_c%ts_n_szangles_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_szangles = 0_fpk
  ts_szangles_ptr => fortran_type_f%ts_szangles
  transfer_struct_c%ts_szangles = c_loc(ts_szangles_ptr(&
    lbound(fortran_type_f%ts_szangles,1)))
  inquire(iolength=transfer_struct_c%ts_szangles_f_byte_size) fortran_type_f%ts_szangles(&
    lbound(fortran_type_f%ts_szangles,1))
#ifdef ifort
  transfer_struct_c%ts_szangles_f_byte_size = transfer_struct_c%ts_szangles_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_szangles_f_shapes(1) = size(fortran_type_f%ts_szangles, 1)
  
  
end subroutine vlidort_modified_sunrays_c_init_only

subroutine vlidort_modified_sunrays_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_sunrays
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_sunrays_c_destroy

subroutine vlidort_modified_sunrays_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_sunrays

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_sunrays), pointer :: fortran_type_f_from
  type(vlidort_modified_sunrays), pointer :: fortran_type_f_to

  call c_f_pointer(fortran_type_c_from, fortran_type_f_from)
  call c_f_pointer(fortran_type_c_to, fortran_type_f_to)

  fortran_type_f_to%ts_n_szangles = fortran_type_f_from%ts_n_szangles
  fortran_type_f_to%ts_szangles = fortran_type_f_from%ts_szangles
  

end subroutine vlidort_modified_sunrays_c_copy

! Links to type: "vlidort_modified_uservalues" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_uservalues_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_uservalues

  type(vlidort_modified_uservalues_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_uservalues_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_uservalues_c_alloc_init

! Links to type: "vlidort_modified_uservalues" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_uservalues_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  integer(c_int), pointer :: ts_n_user_vzangles_ptr
  real(c_double), dimension(:), pointer :: ts_user_vzangles_input_ptr
  ...
  fortran_type_f%ts_n_user_vzangles = 0
  ts_n_user_vzangles_ptr => fortran_type_f%ts_n_user_vzangles
  transfer_struct_c%ts_n_user_vzangles = c_loc(ts_n_user_vzangles_ptr)
  inquire(iolength=transfer_struct_c%ts_n_user_vzangles_f_byte_size) fortran_type_f%ts_n_user_vzangles
#ifdef ifort
  transfer_struct_c%ts_n_user_vzangles_f_byte_size = transfer_struct_c%ts_n_user_vzangles_f_byte_size * 4
#endif
  
  
  
  fortran_type_f%ts_user_vzangles_input = 0_fpk
  ts_user_vzangles_input_ptr => fortran_type_f%ts_user_vzangles_input
  transfer_struct_c%ts_user_vzangles_input = c_loc(ts_user_vzangles_input_ptr(&
    lbound(fortran_type_f%ts_user_vzangles_input,1)))
  inquire(iolength=transfer_struct_c%ts_user_vzangles_input_f_byte_size) fortran_type_f%ts_user_vzangles_input(&
    lbound(fortran_type_f%ts_user_vzangles_input,1))
#ifdef ifort
  transfer_struct_c%ts_user_vzangles_input_f_byte_size = transfer_struct_c%ts_user_vzangles_input_f_byte_size * 4
#endif
  
  transfer_struct_c%ts_user_vzangles_input_f_shapes(1) = size(fortran_type_f%ts_user_vzangles_input, 1)
...
end subroutine vlidort_modified_uservalues_c_init_only

subroutine vlidort_modified_uservalues_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_uservalues
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_uservalues_c_destroy

subroutine vlidort_modified_uservalues_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_uservalues

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_uservalues), pointer :: fortran_type_f_from
  type(vlidort_modified_uservalues), pointer :: fortran_type_f_to
  ...
  fortran_type_f_to%ts_n_user_vzangles = fortran_type_f_from%ts_n_user_vzangles
  fortran_type_f_to%ts_user_vzangles_input = fortran_type_f_from%ts_user_vzangles_input
...
end subroutine vlidort_modified_uservalues_c_copy

! Links to type: "vlidort_modified_chapman" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_chapman_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_chapman

  type(vlidort_modified_chapman_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_chapman_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_chapman_c_alloc_init

! Links to type: "vlidort_modified_chapman" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_chapman_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_modified_chapman_c_init_only

subroutine vlidort_modified_chapman_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_chapman
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_chapman_c_destroy

subroutine vlidort_modified_chapman_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_chapman

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_chapman), pointer :: fortran_type_f_from
  type(vlidort_modified_chapman), pointer :: fortran_type_f_to
...
end subroutine vlidort_modified_chapman_c_copy

! Links to type: "vlidort_modified_optical" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_optical_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_optical

  type(vlidort_modified_optical_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_optical_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_optical_c_alloc_init

! Links to type: "vlidort_modified_optical" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_optical_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
...
end subroutine vlidort_modified_optical_c_init_only

subroutine vlidort_modified_optical_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_optical
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_optical_c_destroy

subroutine vlidort_modified_optical_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_optical

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_optical), pointer :: fortran_type_f_from
  type(vlidort_modified_optical), pointer :: fortran_type_f_to
...
end subroutine vlidort_modified_optical_c_copy

! Links to type: "vlidort_modified_inputs" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Allocs and initializes type
subroutine vlidort_modified_inputs_c_alloc_init(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_inputs

  type(vlidort_modified_inputs_c), intent(inout) :: transfer_struct_c
  type(c_ptr), intent(inout) :: fortran_type_c
  ...
  call vlidort_modified_inputs_c_init_only(transfer_struct_c, fortran_type_c) 

end subroutine vlidort_modified_inputs_c_alloc_init

! Links to type: "vlidort_modified_inputs" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
! Initializes only with no allocation
subroutine vlidort_modified_inputs_c_init_only(transfer_struct_c, fortran_type_c) bind(C)
  use vlidort_inputs_def_m
  use vlidort_pars_m
  ...
  type(vlidort_modified_boolean), pointer :: mbool_ptr
  type(vlidort_modified_control), pointer :: mcont_ptr
  type(vlidort_modified_sunrays), pointer :: msunrays_ptr
  type(vlidort_modified_uservalues), pointer :: muserval_ptr
  type(vlidort_modified_chapman), pointer :: mchapman_ptr
  type(vlidort_modified_optical), pointer :: moptical_ptr
...
end subroutine vlidort_modified_inputs_c_init_only

subroutine vlidort_modified_inputs_c_destroy(fortran_type_c) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_inputs
  ...
  deallocate(fortran_type_f)
end subroutine vlidort_modified_inputs_c_destroy

subroutine vlidort_modified_inputs_c_copy(fortran_type_c_from, fortran_type_c_to) bind(C)
  use vlidort_inputs_def_m, only : vlidort_modified_inputs

  type(c_ptr), intent(inout) :: fortran_type_c_from
  type(c_ptr), intent(inout) :: fortran_type_c_to

  type(vlidort_modified_inputs), pointer :: fortran_type_f_from
  type(vlidort_modified_inputs), pointer :: fortran_type_f_to
...
end subroutine vlidort_modified_inputs_c_copy


! Wrapper for character variable "bs_brdf_names" of type: "vbrdf_sup_inputs" from module: "vbrdf_sup_inputs_def_m" in file: "vbrdf_sup_inputs_def.f90"
subroutine vbrdf_sup_inputs_bs_brdf_names_get(fortran_type_c, bs_brdf_names_in_shape_1, &
...
end subroutine vbrdf_sup_inputs_bs_brdf_names_get
! Wrapper for character variable "bs_inputmessages" of type: "vbrdf_input_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
subroutine vbrdf_input_exception_handling_bs_inputmessages_get(fortran_type_c, bs_inputmessages_in_shape_1, &
...
end subroutine vbrdf_input_exception_handling_bs_inputmessages_get
! Wrapper for character variable "bs_inputactions" of type: "vbrdf_input_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
subroutine vbrdf_input_exception_handling_bs_inputactions_get(fortran_type_c, bs_inputactions_in_shape_1, &
...
end subroutine vbrdf_input_exception_handling_bs_inputactions_get
! Wrapper for character variable "bs_outputmessages" of type: "vbrdf_output_exception_handling" from module: "vbrdf_sup_outputs_def_m" in file: "vbrdf_sup_outputs_def.f90"
subroutine vbrdf_output_exception_handling_bs_outputmessages_get(fortran_type_c, bs_outputmessages_in_shape_1, &
...
end subroutine vbrdf_output_exception_handling_bs_outputmessages_get
! Wrapper for character variable "sl_vsleave_datapath" of type: "vsleave_sup_inputs" from module: "vsleave_sup_inputs_def_m" in file: "vsleave_sup_inputs_def.f90"
subroutine vsleave_sup_inputs_sl_vsleave_datapath_get(fortran_type_c, sl_vsleave_datapath_in_len, &
      sl_vsleave_datapath_in) bind(C)
  use vsleave_sup_inputs_def_m, only : vsleave_sup_inputs

  type(c_ptr), intent(inout) :: fortran_type_c
  integer(c_int), intent(in) :: sl_vsleave_datapath_in_len
  character(kind=c_char) , intent(inout) :: sl_vsleave_datapath_in(sl_vsleave_datapath_in_len+1)
  ...
  do len_idx = 1, sl_vsleave_datapath_in_len
    sl_vsleave_datapath_in(len_idx) = &
      fortran_type_f%sl_vsleave_datapath(len_idx:len_idx)
  end do
  len_idx = len_trim(fortran_type_f%sl_vsleave_datapath(:))+1
  sl_vsleave_datapath_in(len_idx) = c_null_char

end subroutine vsleave_sup_inputs_sl_vsleave_datapath_get
! Wrapper for character variable "ts_columnwf_names" of type: "vlidort_fixed_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
subroutine v_fixed_lincontrol_ts_columnwf_names_get(fortran_type_c, ts_columnwf_names_in_shape_1, &
...
end subroutine v_fixed_lincontrol_ts_columnwf_names_get
! Wrapper for character variable "ts_profilewf_names" of type: "vlidort_fixed_lincontrol" from module: "vlidort_lininputs_def_m" in file: "vlidort_lin_inputs_def.f90"
subroutine v_fixed_lincontrol_ts_profilewf_names_get(fortran_type_c, ts_profilewf_names_in_shape_1, &
...
end subroutine v_fixed_lincontrol_ts_profilewf_names_get
! Wrapper for character variable "ts_checkmessages" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_checkmessages_get(fortran_type_c, ts_checkmessages_in_shape_1, &
...
end subroutine v_exception_handling_ts_checkmessages_get
! Wrapper for character variable "ts_actions" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_actions_get(fortran_type_c, ts_actions_in_shape_1, &
      ts_actions_in_len, &
...
end subroutine v_exception_handling_ts_actions_get
! Wrapper for character variable "ts_message" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_message_get(fortran_type_c, ts_message_in_len, &
...
end subroutine v_exception_handling_ts_message_get
! Wrapper for character variable "ts_trace_1" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_trace_1_get(fortran_type_c, ts_trace_1_in_len, &
...
end subroutine v_exception_handling_ts_trace_1_get
! Wrapper for character variable "ts_trace_2" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_trace_2_get(fortran_type_c, ts_trace_2_in_len, &
...
end subroutine v_exception_handling_ts_trace_2_get
! Wrapper for character variable "ts_trace_3" of type: "vlidort_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_exception_handling_ts_trace_3_get(fortran_type_c, ts_trace_3_in_len, &
...
end subroutine v_exception_handling_ts_trace_3_get
! Wrapper for character variable "ts_inputmessages" of type: "vlidort_input_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_input_exception_handling_ts_inputmessages_get(fortran_type_c, ts_inputmessages_in_shape_1, &
...
end subroutine v_input_exception_handling_ts_inputmessages_get
! Wrapper for character variable "ts_inputactions" of type: "vlidort_input_exception_handling" from module: "vlidort_outputs_def_m" in file: "vlidort_outputs_def.f90"
subroutine v_input_exception_handling_ts_inputactions_get(fortran_type_c, ts_inputactions_in_shape_1, &
...
end subroutine v_input_exception_handling_ts_inputactions_get
! Wrapper for character variable "ts_input_write_filename" of type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
subroutine v_fixed_write_ts_input_write_filename_get(fortran_type_c, ts_input_write_filename_in_len, &
...
end subroutine v_fixed_write_ts_input_write_filename_get
! Wrapper for character variable "ts_scenario_write_filename" of type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
subroutine v_fixed_write_ts_scenario_write_filename_get(fortran_type_c, ts_scenario_write_filename_in_len, &
...
end subroutine v_fixed_write_ts_scenario_write_filename_get
! Wrapper for character variable "ts_fourier_write_filename" of type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
subroutine v_fixed_write_ts_fourier_write_filename_get(fortran_type_c, ts_fourier_write_filename_in_len, &
...
end subroutine v_fixed_write_ts_fourier_write_filename_get
! Wrapper for character variable "ts_results_write_filename" of type: "vlidort_fixed_write" from module: "vlidort_inputs_def_m" in file: "vlidort_inputs_def.f90"
subroutine v_fixed_write_ts_results_write_filename_get(fortran_type_c, ts_results_write_filename_in_len, &
...
end subroutine v_fixed_write_ts_results_write_filename_get


end module vlidort_interface_types