...
struct vlidort_pars_m {
  ...
  int vlidort_inunit;
  int vlidort_resunit;
  int vlidort_scenunit;
  int vlidort_serious;
  int vlidort_success;
  char vlidort_version_number[3];
  int vlidort_warning;
  double zero;
...
public:
  ...
  const int& gisscoxmunk_cri_idx() const {
    return transfer_struct_c.gisscoxmunk_cri_idx;
  }

  const int& gisscoxmunk_idx() const {
    return transfer_struct_c.gisscoxmunk_idx;
  }
  ...
  const int& max_psols() const {
    return transfer_struct_c.max_psols;
  }

  const int& max_scatpsols() const {
    return transfer_struct_c.max_scatpsols;
  }
  ...
  const int& max_szangles() const {
    return transfer_struct_c.max_szangles;
  }
  ...
  const int& max_user_vzangles() const {
    return transfer_struct_c.max_user_vzangles;
  }

  const int& max_ustrmstks() const {
    return transfer_struct_c.max_ustrmstks;
  }
  ...
  const int& maxevalues() const {
    return transfer_struct_c.maxevalues;
  }
  ...
  const int& maxstokes() const {
    return transfer_struct_c.maxstokes;
  }

  const int& maxstokes_sq() const {
    return transfer_struct_c.maxstokes_sq;
  }
  ...
  const int& maxstreams_21() const {
    return transfer_struct_c.maxstreams_21;
  }
  ...
  const int& maxstreams_p2() const {
    return transfer_struct_c.maxstreams_p2;
  }
  ...
  const int& maxstrmstks() const {
    return transfer_struct_c.maxstrmstks;
  }

  const int& maxstrmstks_2() const {
    return transfer_struct_c.maxstrmstks_2;
  }

  const int& maxstrmstks_21() const {
    return transfer_struct_c.maxstrmstks_21;
  }

  const int& maxstrmstks_p1() const {
    return transfer_struct_c.maxstrmstks_p1;
  }

  const int& maxstrmstks_p2() const {
    return transfer_struct_c.maxstrmstks_p2;
  }

  const int& maxstrmstks_p4() const {
    return transfer_struct_c.maxstrmstks_p4;
  }
  ...
  const int& newgcmglint_idx() const {
    return transfer_struct_c.newgcmglint_idx;
  }
  ...
  const double& taylor_large() const {
    return transfer_struct_c.taylor_large;
  }
  ...
  const int& vlidort_debug() const {
    return transfer_struct_c.vlidort_debug;
  }

  const int& vlidort_errunit() const {
    return transfer_struct_c.vlidort_errunit;
  }

  const int& vlidort_funit() const {
    return transfer_struct_c.vlidort_funit;
  }

  const int& vlidort_info() const {
    return transfer_struct_c.vlidort_info;
  }

  const int& vlidort_inunit() const {
    return transfer_struct_c.vlidort_inunit;
  }

  const int& vlidort_resunit() const {
    return transfer_struct_c.vlidort_resunit;
  }

  const int& vlidort_scenunit() const {
    return transfer_struct_c.vlidort_scenunit;
  }

  const int& vlidort_serious() const {
    return transfer_struct_c.vlidort_serious;
  }

  const int& vlidort_success() const {
    return transfer_struct_c.vlidort_success;
  }

  const std::string vlidort_version_number() const {
    return std::string(transfer_struct_c.vlidort_version_number);
  }

  const int& vlidort_warning() const {
    return transfer_struct_c.vlidort_warning;
  }
  ...
  virtual void print(std::ostream &output_stream) const {
    output_stream << "VLidort_Pars:" << std::endl
      ...
      << "                  eps5: " << eps5()  << std::endl
      << "                  four: " << four()  << std::endl
      << "   gisscoxmunk_cri_idx: " << gisscoxmunk_cri_idx()  << std::endl
      << "       gisscoxmunk_idx: " << gisscoxmunk_idx()  << std::endl
      << "                  half: " << half()  << std::endl
      ...
      << "             max_psols: " << max_psols()  << std::endl
      << "         max_scatpsols: " << max_scatpsols()  << std::endl
      << "         max_sleavewfs: " << max_sleavewfs()  << std::endl
      << "        max_surfacewfs: " << max_surfacewfs()  << std::endl
      << "          max_szangles: " << max_szangles()  << std::endl
      ...
      << "     max_user_vzangles: " << max_user_vzangles()  << std::endl
      << "         max_ustrmstks: " << max_ustrmstks()  << std::endl
      << "          maxbandtotal: " << maxbandtotal()  << std::endl
      << "              maxbeams: " << maxbeams()  << std::endl
      << "           maxbrdf_idx: " << maxbrdf_idx()  << std::endl
      << "            maxevalues: " << maxevalues()  << std::endl
      ...
      << "             maxstokes: " << maxstokes()  << std::endl
      << "          maxstokes_sq: " << maxstokes_sq()  << std::endl
      << "            maxstreams: " << maxstreams()  << std::endl
      << "          maxstreams_2: " << maxstreams_2()  << std::endl
      << "         maxstreams_21: " << maxstreams_21()  << std::endl
      << "       maxstreams_brdf: " << maxstreams_brdf()  << std::endl
      << "         maxstreams_p1: " << maxstreams_p1()  << std::endl
      << "         maxstreams_p2: " << maxstreams_p2()  << std::endl
      << "    maxstreams_scaling: " << maxstreams_scaling()  << std::endl
      << "           maxstrmstks: " << maxstrmstks()  << std::endl
      << "         maxstrmstks_2: " << maxstrmstks_2()  << std::endl
      << "        maxstrmstks_21: " << maxstrmstks_21()  << std::endl
      << "        maxstrmstks_p1: " << maxstrmstks_p1()  << std::endl
      << "        maxstrmstks_p2: " << maxstrmstks_p2()  << std::endl
      << "        maxstrmstks_p4: " << maxstrmstks_p4()  << std::endl
      ...
      << "       newgcmglint_idx: " << newgcmglint_idx()  << std::endl
      ...
      << "          taylor_large: " << taylor_large()  << std::endl
      << "          taylor_small: " << taylor_small()  << std::endl
      << "                 three: " << three()  << std::endl
      << "                   two: " << two()  << std::endl
      << "                 upidx: " << upidx()  << std::endl
      << "         vlidort_debug: " << vlidort_debug()  << std::endl
      << "       vlidort_errunit: " << vlidort_errunit()  << std::endl
      << "         vlidort_funit: " << vlidort_funit()  << std::endl
      << "          vlidort_info: " << vlidort_info()  << std::endl
      << "        vlidort_inunit: " << vlidort_inunit()  << std::endl
      << "       vlidort_resunit: " << vlidort_resunit()  << std::endl
      << "      vlidort_scenunit: " << vlidort_scenunit()  << std::endl
      << "       vlidort_serious: " << vlidort_serious()  << std::endl
      << "       vlidort_success: " << vlidort_success()  << std::endl
      << "vlidort_version_number: " << "\"" << vlidort_version_number() << "\"" << std::endl
      << "       vlidort_warning: " << vlidort_warning()  << std::endl
      << "                  zero: " << zero()  << std::endl;

  }

  VLidort_Pars() { 
    set_vlidort_pars(&transfer_struct_c);
  }

private:
  struct vlidort_pars_m transfer_struct_c;
};
...
public:
  // Allocating constructor
  VSleave_Sup_Inputs() : Sleave_Sup_Inputs_Base() {
  ...
  // Linked to other data structure
  VSleave_Sup_Inputs(void* allocated_f_type_c) : Sleave_Sup_Inputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Lincontrol() : Spurr_Fixed_Lincontrol_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Lincontrol(void* allocated_f_type_c) : Spurr_Fixed_Lincontrol_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Linoptical() : Spurr_Fixed_Linoptical_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Linoptical(void* allocated_f_type_c) : Spurr_Fixed_Linoptical_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Lininputs() : Spurr_Fixed_Lininputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Lininputs(void* allocated_f_type_c) : Spurr_Fixed_Lininputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Lincontrol() : Spurr_Modified_Lincontrol_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Lincontrol(void* allocated_f_type_c) : Spurr_Modified_Lincontrol_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Lininputs() : Spurr_Modified_Lininputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Lininputs(void* allocated_f_type_c) : Spurr_Modified_Lininputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Lincol() : Spurr_Type_Structure() {
  ...
  // Linked to other data structure
  VLidort_Lincol(void* allocated_f_type_c) : Spurr_Type_Structure(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linprof() : Spurr_Type_Structure() {
  ...
  // Linked to other data structure
  VLidort_Linprof(void* allocated_f_type_c) : Spurr_Type_Structure(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linatmos() : Spurr_Linatmos_Base() {
  ...
  // Linked to other data structure
  VLidort_Linatmos(void* allocated_f_type_c) : Spurr_Linatmos_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linsurf() : Spurr_Linsurf_Base() {
  ...
  // Linked to other data structure
  VLidort_Linsurf(void* allocated_f_type_c) : Spurr_Linsurf_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linoutputs() : Spurr_Linoutputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Linoutputs(void* allocated_f_type_c) : Spurr_Linoutputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linsup_Ss_Col() : Spurr_Type_Structure() {
  ...
  // Linked to other data structure
  VLidort_Linsup_Ss_Col(void* allocated_f_type_c) : Spurr_Type_Structure(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Linsup_Ss_Prof() : Spurr_Type_Structure() {
  ...
  // Linked to other data structure
  VLidort_Linsup_Ss_Prof(void* allocated_f_type_c) : Spurr_Type_Structure(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Main_Outputs() : Spurr_Main_Outputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Main_Outputs(void* allocated_f_type_c) : Spurr_Main_Outputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Wladjusted_Outputs() : Spurr_Wladjusted_Outputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Wladjusted_Outputs(void* allocated_f_type_c) : Spurr_Wladjusted_Outputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Exception_Handling() : Spurr_Exception_Handling_Base() {
  ...
  // Linked to other data structure
  VLidort_Exception_Handling(void* allocated_f_type_c) : Spurr_Exception_Handling_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Input_Exception_Handling() : Spurr_Input_Exception_Handling_Base() {
  ...
  // Linked to other data structure
  VLidort_Input_Exception_Handling(void* allocated_f_type_c) : Spurr_Input_Exception_Handling_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Outputs() : Spurr_Outputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Outputs(void* allocated_f_type_c) : Spurr_Outputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Sup_Brdf() : Spurr_Sup_Brdf_Base() {
  ...
  // Linked to other data structure
  VLidort_Sup_Brdf(void* allocated_f_type_c) : Spurr_Sup_Brdf_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Sup_Sleave() : Spurr_Sup_Sleave_Base() {
  ...
  // Linked to other data structure
  VLidort_Sup_Sleave(void* allocated_f_type_c) : Spurr_Sup_Sleave_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Sup_Ss() : Spurr_Sup_Ss_Base() {
  ...
  // Linked to other data structure
  VLidort_Sup_Ss(void* allocated_f_type_c) : Spurr_Sup_Ss_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Sup_Inout() : Spurr_Sup_Inout_Base() {
  ...
  // Linked to other data structure
  VLidort_Sup_Inout(void* allocated_f_type_c) : Spurr_Sup_Inout_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Boolean() : Spurr_Fixed_Boolean_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Boolean(void* allocated_f_type_c) : Spurr_Fixed_Boolean_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Control() : Spurr_Fixed_Control_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Control(void* allocated_f_type_c) : Spurr_Fixed_Control_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Sunrays() : Spurr_Fixed_Sunrays_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Sunrays(void* allocated_f_type_c) : Spurr_Fixed_Sunrays_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Uservalues() : Spurr_Fixed_Uservalues_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Uservalues(void* allocated_f_type_c) : Spurr_Fixed_Uservalues_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Chapman() : Spurr_Fixed_Chapman_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Chapman(void* allocated_f_type_c) : Spurr_Fixed_Chapman_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Optical() : Spurr_Fixed_Optical_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Optical(void* allocated_f_type_c) : Spurr_Fixed_Optical_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Write() : Spurr_Fixed_Write_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Write(void* allocated_f_type_c) : Spurr_Fixed_Write_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Fixed_Inputs() : Spurr_Fixed_Inputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Fixed_Inputs(void* allocated_f_type_c) : Spurr_Fixed_Inputs_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Boolean() : Spurr_Modified_Boolean_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Boolean(void* allocated_f_type_c) : Spurr_Modified_Boolean_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Control() : Spurr_Modified_Control_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Control(void* allocated_f_type_c) : Spurr_Modified_Control_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Sunrays() : Spurr_Modified_Sunrays_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Sunrays(void* allocated_f_type_c) : Spurr_Modified_Sunrays_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Uservalues() : Spurr_Modified_Uservalues_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Uservalues(void* allocated_f_type_c) : Spurr_Modified_Uservalues_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Chapman() : Spurr_Modified_Chapman_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Chapman(void* allocated_f_type_c) : Spurr_Modified_Chapman_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Optical() : Spurr_Modified_Optical_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Optical(void* allocated_f_type_c) : Spurr_Modified_Optical_Base(allocated_f_type_c) {
...
public:
  // Allocating constructor
  VLidort_Modified_Inputs() : Spurr_Modified_Inputs_Base() {
  ...
  // Linked to other data structure
  VLidort_Modified_Inputs(void* allocated_f_type_c) : Spurr_Modified_Inputs_Base(allocated_f_type_c) {
