...
BOOST_AUTO_TEST_CASE(vlidort_pars)
{
  ...
  BOOST_CHECK_EQUAL(tst_obj.deg_to_rad(), 1.7453292519943e-02);
  ...
  BOOST_CHECK_EQUAL(tst_obj.gisscoxmunk_cri_idx(), 18);
  BOOST_CHECK_EQUAL(tst_obj.gisscoxmunk_idx(), 17);
  ...
  BOOST_CHECK_EQUAL(tst_obj.maxbrdf_idx(), tst_obj.newgcmglint_idx());
  ...
  BOOST_CHECK_EQUAL(tst_obj.newgcmglint_idx(), 19);
  BOOST_CHECK_EQUAL(tst_obj.omega_smallnum(), 1.0e-15);
  ...
  BOOST_CHECK_EQUAL(tst_obj.smallnum(), 1.0e-9);
  BOOST_CHECK_EQUAL(tst_obj.snowbrdf_idx(), SNOWBRDF);
  BOOST_CHECK_EQUAL(tst_obj.taylor_large(), 1.0e+04);
  BOOST_CHECK_EQUAL(tst_obj.taylor_small(), 1.0e-04);
