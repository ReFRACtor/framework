...
BOOST_FIXTURE_TEST_SUITE(aerosol_param_output, ConfigurationFixture)

BOOST_AUTO_TEST_CASE(basic)
{
  boost::shared_ptr<AerosolOptical> a = boost::dynamic_pointer_cast<AerosolOptical>(config_aerosol);
