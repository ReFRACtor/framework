...
#SRC_DIR="$SRC_DIR/thirdparty/first_order"
cmake -DBUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=$PREFIX -DCMAKE_INSTALL_LIBDIR=lib -DCMAKE_Fortran_MODULE_DIRECTORY=$PREFIX/include $SRC_DIR 
